 ...
 *
 * $Id: BaseActionBarContributor.java,v 1.1 2008-08-08 10:10:35 estepper Exp $
 */
...
public class BaseActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
  ...
  {
    toolBarManager.add(new Separator("base-settings")); //$NON-NLS-1$
    toolBarManager.add(new Separator("base-additions")); //$NON-NLS-1$
  }
