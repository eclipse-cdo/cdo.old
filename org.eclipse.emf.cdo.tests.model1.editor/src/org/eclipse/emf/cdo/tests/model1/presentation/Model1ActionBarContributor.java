...
/**
 * This is the action bar contributor for the Model1 model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class Model1ActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
   ...
   * @generated
   */
  protected IAction showPropertiesViewAction = new Action(Model1EditorPlugin.INSTANCE
   ...
   * @generated
   */
  protected IAction refreshViewerAction = new Action(Model1EditorPlugin.INSTANCE
  ...
  public void contributeToMenu(IMenuManager menuManager)
  {
    ...
    IMenuManager submenuManager = new MenuManager(Model1EditorPlugin.INSTANCE.getString("_UI_Model1Editor_menu"),
        "org.eclipse.emf.cdo.tests.model1MenuID");
