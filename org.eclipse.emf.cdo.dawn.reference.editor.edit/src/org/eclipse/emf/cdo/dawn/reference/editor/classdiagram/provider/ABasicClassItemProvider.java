...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.ABasicClass}
    ...
    IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
  ...
  protected void addNamePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
        ...
        ClassdiagramPackage.Literals.ABASIC_CLASS__NAME, true, false, false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ClassdiagramPackage.Literals.ABASIC_CLASS__OPERATIONS);
      childrenFeatures.add(ClassdiagramPackage.Literals.ABASIC_CLASS__ATTRIBUTES);
    }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    {
    case ClassdiagramPackage.ABASIC_CLASS__NAME:
      fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
      return;
    case ClassdiagramPackage.ABASIC_CLASS__OPERATIONS:
    case ClassdiagramPackage.ABASIC_CLASS__ATTRIBUTES:
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add(createChildParameter(ClassdiagramPackage.Literals.ABASIC_CLASS__OPERATIONS,
        ClassdiagramFactory.eINSTANCE.createAnOperation()));

    newChildDescriptors.add(createChildParameter(ClassdiagramPackage.Literals.ABASIC_CLASS__ATTRIBUTES,
        ClassdiagramFactory.eINSTANCE.createAnAttribute()));
  }
