 ...
 * </copyright>
 *
 * $Id: Net4jdefstestsSwitch.java,v 1.1 2008-12-28 18:07:20 estepper Exp $
 */
 ...
 * @generated
 */
public class Net4jdefstestsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Net4jdefstestsPackage.TEST_DEF: {
