 ...
 * @generated
 */
public class AInterfaceAnOperationInterfaceCompartmentEditPart extends ListCompartmentEditPart
{
   ...
   * @generated
   */
  public AInterfaceAnOperationInterfaceCompartmentEditPart(View view)
  {
    super(view);
  }
  ...
  {
    return Messages.AInterfaceAnOperationInterfaceCompartmentEditPart_title;
  }
  ...
  protected void createDefaultEditPolicies()
  {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new AInterfaceAnOperationInterfaceCompartmentItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
    installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
        new AInterfaceAnOperationInterfaceCompartmentCanonicalEditPolicy());
  }
