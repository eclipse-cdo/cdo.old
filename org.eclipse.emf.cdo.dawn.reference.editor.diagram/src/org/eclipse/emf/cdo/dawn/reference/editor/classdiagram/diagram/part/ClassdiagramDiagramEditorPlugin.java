...
import org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.provider.ClassdiagramItemProviderAdapterFactory;
...
public class ClassdiagramDiagramEditorPlugin extends AbstractUIPlugin
{
   ...
   * @generated
   */
  public static final String ID = "org.eclipse.emf.cdo.dawn.reference.editor.diagram"; //$NON-NLS-1$
  ...
  public void logError(String error, Throwable throwable)
  {
    ...
    getLog().log(new Status(IStatus.ERROR, ClassdiagramDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
  ...
  public void logInfo(String message, Throwable throwable)
  {
    ...
    getLog().log(new Status(IStatus.INFO, ClassdiagramDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
