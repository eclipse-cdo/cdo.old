...
public class AClassCompositionsReorientCommand extends EditElementCommand
{
  ...
  protected boolean canReorientSource()
  {
    ...
    return ClassdiagramBaseItemSemanticEditPolicy.LinkConstraints.canExistAClassCompositions_4005(getNewSource(),
        getOldTarget());
  }
  ...
  protected boolean canReorientTarget()
  {
    ...
    return ClassdiagramBaseItemSemanticEditPolicy.LinkConstraints.canExistAClassCompositions_4005(getOldSource(),
        getNewTarget());
  }
