...
public class AClassAggregationsReorientCommand extends EditElementCommand
{
  ...
  protected boolean canReorientSource()
  {
    ...
    return ClassdiagramBaseItemSemanticEditPolicy.LinkConstraints.canExistAClassAggregations_4004(getNewSource(),
        getOldTarget());
  }
  ...
  protected boolean canReorientTarget()
  {
    ...
    return ClassdiagramBaseItemSemanticEditPolicy.LinkConstraints.canExistAClassAggregations_4004(getOldSource(),
        getNewTarget());
  }
