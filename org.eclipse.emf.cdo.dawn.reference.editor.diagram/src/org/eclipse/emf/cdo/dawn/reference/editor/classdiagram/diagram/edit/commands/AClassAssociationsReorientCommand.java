...
public class AClassAssociationsReorientCommand extends EditElementCommand
{
  ...
  protected boolean canReorientSource()
  {
    ...
    return ClassdiagramBaseItemSemanticEditPolicy.LinkConstraints.canExistAClassAssociations_4003(getNewSource(),
        getOldTarget());
  }
  ...
  protected boolean canReorientTarget()
  {
    ...
    return ClassdiagramBaseItemSemanticEditPolicy.LinkConstraints.canExistAClassAssociations_4003(getOldSource(),
        getNewTarget());
  }
