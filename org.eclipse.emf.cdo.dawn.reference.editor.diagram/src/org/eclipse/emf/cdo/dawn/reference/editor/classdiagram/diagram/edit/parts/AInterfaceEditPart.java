...
import org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.diagram.edit.policies.AInterfaceItemSemanticEditPolicy;
...
public class AInterfaceEditPart extends ShapeNodeEditPart
{
    ...
    ConstrainedToolbarLayoutEditPolicy lep = new ConstrainedToolbarLayoutEditPolicy()
    {
      ...
      protected EditPolicy createChildEditPolicy(EditPart child)
      {
        if (child.getEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE) == null)
        {
          ...
          {
            return new ClassdiagramTextSelectionEditPolicy();
          }
        }
  ...
  protected boolean addFixedChild(EditPart childEditPart)
  {
    ...
    if (childEditPart instanceof AInterfaceAnAttributeInterfaceCompartmentEditPart)
    {
      IFigure pane = getPrimaryShape().getFigureInterfaceAttributes();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((AInterfaceAnAttributeInterfaceCompartmentEditPart)childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof AInterfaceAnOperationInterfaceCompartmentEditPart)
    {
      IFigure pane = getPrimaryShape().getFigureInterfaceOperations();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.add(((AInterfaceAnOperationInterfaceCompartmentEditPart)childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  protected boolean removeFixedChild(EditPart childEditPart)
  {
    ...
    if (childEditPart instanceof AInterfaceAnAttributeInterfaceCompartmentEditPart)
    {
      IFigure pane = getPrimaryShape().getFigureInterfaceAttributes();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.remove(((AInterfaceAnAttributeInterfaceCompartmentEditPart)childEditPart).getFigure());
      return true;
    }
    if (childEditPart instanceof AInterfaceAnOperationInterfaceCompartmentEditPart)
    {
      IFigure pane = getPrimaryShape().getFigureInterfaceOperations();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
      pane.remove(((AInterfaceAnOperationInterfaceCompartmentEditPart)childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  {
    if (editPart instanceof AInterfaceAnAttributeInterfaceCompartmentEditPart)
    {
      return getPrimaryShape().getFigureInterfaceAttributes();
    }
    if (editPart instanceof AInterfaceAnOperationInterfaceCompartmentEditPart)
    {
  ...
  {
    return getChildBySemanticHint(ClassdiagramVisualIDRegistry.getType(AInterfaceNameEditPart.VISUAL_ID));
  }
  ...
  public EditPart getTargetEditPart(Request request)
  {
    if (request instanceof CreateViewAndElementRequest)
    {
      ...
      if (type == ClassdiagramElementTypes.AnAttribute_3001)
      {
      ...
      if (type == ClassdiagramElementTypes.AnOperation_3002)
      {
        return getChildBySemanticHint(ClassdiagramVisualIDRegistry
