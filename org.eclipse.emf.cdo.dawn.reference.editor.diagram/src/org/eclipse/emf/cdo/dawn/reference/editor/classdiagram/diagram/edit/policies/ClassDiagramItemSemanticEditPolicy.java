 ...
 * @generated
 */
public class ClassDiagramItemSemanticEditPolicy extends ClassdiagramBaseItemSemanticEditPolicy
{
  ...
  {
    super(ClassdiagramElementTypes.ClassDiagram_1000);
  }
  ...
  {
    if (ClassdiagramElementTypes.AInterface_2001 == req.getElementType())
    {
      return getGEFWrapper(new AInterfaceCreateCommand(req));
    }
    if (ClassdiagramElementTypes.AClass_2002 == req.getElementType())
    {
