...
public class ClassdiagramNavigatorLinkHelper implements ILinkHelper
{
  ...
  {
    IDiagramDocument document = ClassdiagramDiagramEditorPlugin.getInstance().getDocumentProvider().getDiagramDocument(
        anInput);
    if (document == null)
    {
  ...
  public void activateEditor(IWorkbenchPage aPage, IStructuredSelection aSelection)
  {
    ...
    if (false == aSelection.getFirstElement() instanceof ClassdiagramAbstractNavigatorItem)
    {
      return;
    }
