 ...
 * @generated
 */
public class ClassdiagramBaseItemSemanticEditPolicy extends SemanticEditPolicy
{
   ...
   * @generated
   */
  protected ClassdiagramBaseItemSemanticEditPolicy(IElementType elementType)
  {
  ...
  public Command getCommand(Request request)
  {
    if (request instanceof ReconnectRequest)
    {
      ...
      {
        Integer id = new Integer(ClassdiagramVisualIDRegistry.getVisualID((View)view));
  ...
  private Command getEditHelperCommand(IEditCommandRequest request, Command editPolicyCommand)
  {
    if (editPolicyCommand != null)
    {
      ...
      request.setParameter(ClassdiagramBaseEditHelper.EDIT_POLICY_COMMAND, command);
    }
    IElementType requestContextElementType = getContextElementType(request);
    request.setParameter(ClassdiagramBaseEditHelper.CONTEXT_ELEMENT_TYPE, requestContextElementType);
    ICommand command = requestContextElementType.getEditCommand(request);
    request.setParameter(ClassdiagramBaseEditHelper.EDIT_POLICY_COMMAND, null);
    request.setParameter(ClassdiagramBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
    if (command != null)
    {
  ...
  {
    IElementType requestContextElementType = ClassdiagramElementTypes.getElementType(getVisualID(request));
