  ...
  public EditPart createEditPart(EditPart context, Object model)
  {
    if (model instanceof View)
    {
      ...
      case AnAttributeEditPart.VISUAL_ID:
        return new AnAttributeEditPart(view);

      case AnOperationEditPart.VISUAL_ID:
        return new AnOperationEditPart(view);

      case AnAttribute2EditPart.VISUAL_ID:
        return new AnAttribute2EditPart(view);

      case AnOperation2EditPart.VISUAL_ID:
        return new AnOperation2EditPart(view);

      case AInterfaceAnAttributeInterfaceCompartmentEditPart.VISUAL_ID:
        return new AInterfaceAnAttributeInterfaceCompartmentEditPart(view);

      case AInterfaceAnOperationInterfaceCompartmentEditPart.VISUAL_ID:
        return new AInterfaceAnOperationInterfaceCompartmentEditPart(view);

      case AClassAnAttributeCompartmentEditPart.VISUAL_ID:
        return new AClassAnAttributeCompartmentEditPart(view);

      case AClassAnOperationClassCompartmentEditPart.VISUAL_ID:
        return new AClassAnOperationClassCompartmentEditPart(view);
