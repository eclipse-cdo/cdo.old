...
import org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.diagram.edit.policies.AnOperation2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AnOperation2EditPart extends CompartmentEditPart implements ITextAwareEditPart
{
   ...
   * @generated
   */
  public AnOperation2EditPart(View view)
  {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies()
  {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AnOperation2ItemSemanticEditPolicy());
    installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new ClassdiagramTextNonResizableEditPolicy());
  ...
  public void setLabelText(String text)
  {
    ...
    if (pdEditPolicy instanceof ClassdiagramTextSelectionEditPolicy)
    {
      ((ClassdiagramTextSelectionEditPolicy)pdEditPolicy).refreshFeedback();
    }
    Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
    if (sfEditPolicy instanceof ClassdiagramTextSelectionEditPolicy)
    {
      ((ClassdiagramTextSelectionEditPolicy)sfEditPolicy).refreshFeedback();
    }
  }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      parser = ClassdiagramParserProvider
          .getParser(
              ClassdiagramElementTypes.AnOperation_3004,
              getParserElement(),
              ClassdiagramVisualIDRegistry
                  .getType(org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.diagram.edit.parts.AnOperation2EditPart.VISUAL_ID));
    }
    return parser;
  }
  ...
  protected DirectEditManager getManager()
  {
    if (manager == null)
    {
      setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this),
          ClassdiagramEditPartFactory.getTextCellEditorLocator(this)));
    }
    return manager;
  }
