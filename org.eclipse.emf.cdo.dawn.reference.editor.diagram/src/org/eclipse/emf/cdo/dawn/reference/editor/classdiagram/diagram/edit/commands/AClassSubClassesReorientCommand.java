...
public class AClassSubClassesReorientCommand extends EditElementCommand
{
  ...
  protected boolean canReorientSource()
  {
    ...
    return ClassdiagramBaseItemSemanticEditPolicy.LinkConstraints.canExistAClassSubClasses_4001(getNewSource(),
        getOldTarget());
  }
  ...
  protected boolean canReorientTarget()
  {
    ...
    return ClassdiagramBaseItemSemanticEditPolicy.LinkConstraints.canExistAClassSubClasses_4001(getOldSource(),
        getNewTarget());
  }
