...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EAttribute</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface EAttribute extends EStructuralFeature
{
   ...
   * <p>
   * An ID attribute explicitly models the one unique {@link org.eclipse.emf.ecore.EClass#getEIDAttribute ID} of an
   * object.
   * </p>
   * 
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.ecore.EAttribute#isID <em>ID</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Returns the value of the '<em><b>EAttribute Type</b></em>' reference. <!-- begin-user-doc -->
   * <p>
