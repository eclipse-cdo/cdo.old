...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EAttribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public interface EAttribute extends EStructuralFeature
{
   ...
   * begin-user-doc -->
   * <p>
   * An ID attribute explicitly models the one unique
   * {@link org.eclipse.emf.ecore.EClass#getEIDAttribute ID} of an object.
   * </p>
   * 
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.ecore.EAttribute#isID <em>ID</em>}'
   ...
   * <!-- begin-user-doc -->
   * <p>
   * The {@link #getEType() type} of an attribute must always be a data type;
