...
public interface FeatureMap extends EList<FeatureMap.Entry>
{
  ...
  interface Entry
  {
    ...
    interface Internal extends Entry
    {
      ...
      NotificationChain inverseAdd(InternalEObject owner, Object otherEnd, int featureID,
          NotificationChain notifications);

      NotificationChain inverseRemove(InternalEObject owner, Object otherEnd, int featureID,
          NotificationChain notifications);
