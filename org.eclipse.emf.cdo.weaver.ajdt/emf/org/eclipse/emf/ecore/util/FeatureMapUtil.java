...
public final class FeatureMapUtil
{
  ...
  {
    FeatureMap.Entry.Internal prototype = ((EStructuralFeature.Internal)eStructuralFeature)
  ...
  public static abstract class BasicFeatureEIterator<E> implements ListIterator<E>
  {
    ...
    public E next()
    {
      if (hasNext())
      {
        ...
        {
          @SuppressWarnings("unchecked")
          E newPreparedResult = (E)featureMap.resolveProxy(eStructuralFeature, entryCursor, cursor, preparedResult);
  ...
  public static class FeatureEList<E> extends AbstractList<E> implements InternalEList.Unsettable<E>,
  ...
  public static class FeatureFeatureMap extends FeatureEList<FeatureMap.Entry> implements FeatureMap.Internal,
      FeatureMap.Internal.Wrapper
  {
    ...
    public boolean addAll(int index, EStructuralFeature feature, Collection<?> values)
    {
      ...
      {
        @SuppressWarnings("unchecked")
        Collection<? extends Entry> entryValues = (Collection<? extends Entry>)values;
  ...
  {
    public FeatureENotificationImpl(InternalEObject owner, int eventType, EStructuralFeature feature, Object oldObject,
    ...
    public int getFeatureID(Class<?> expectedClass)
    {
      if (featureID == NO_FEATURE_ID && feature != null)
      {
        ...
        featureID = containerClass == null ? notifier.eClass().getFeatureID(feature) : notifier
            .eDerivedStructuralFeatureID(feature.getFeatureID(), containerClass);
      }
  ...
  public static class BasicValidator implements Validator
  {
    ...
    public BasicValidator(EClass containingClass, EStructuralFeature eStructuralFeature)
    {
      ...
      else if (isFeatureMap(eStructuralFeature))
      {
        ...
        for (int i = 0, size = containingClass.getFeatureCount(); i < size; ++i)
        {
          ...
          for (EStructuralFeature group = ExtendedMetaData.INSTANCE.getGroup(feature); group != null; group = ExtendedMetaData.INSTANCE
              .getGroup(group))
          {
    ...
    public boolean isIncluded(EStructuralFeature feature)
    {
      if (wildcards == ANY_WILDCARD)
      {
        ...
        return isElement ? featureKind == ExtendedMetaData.ELEMENT_FEATURE && feature != XMLTypeFeatures.TEXT
            && feature != XMLTypeFeatures.CDATA && feature != XMLTypeFeatures.COMMENT
            && feature != XMLTypeFeatures.PROCESSING_INSTRUCTION : featureKind == ExtendedMetaData.ATTRIBUTE_FEATURE;
      }

      if (groupMembers != null
          && (groupMembers.contains(feature) || groupMembers.contains(ExtendedMetaData.INSTANCE.getGroup(feature)) || groupMembers
              .contains(ExtendedMetaData.INSTANCE.getAffiliation(containingClass, feature))))
      {
        return true;
      }
      ...
      if (wildcards != null)
      {
        ...
        {
          int featureKind = ExtendedMetaData.INSTANCE.getFeatureKind(feature);
          return isElement ? featureKind == ExtendedMetaData.ELEMENT_FEATURE
    ...
    if (eStructuralFeature == null)
    {
      return NULL_VALIDATOR;
        ...
        || (eStructuralFeature == XMLTypePackage.Literals.ANY_TYPE__MIXED
            || eStructuralFeature == XMLTypePackage.Literals.ANY_TYPE__ANY || eStructuralFeature == XMLTypePackage.Literals.ANY_TYPE__ANY_ATTRIBUTE)
        && containingClass != XMLTypePackage.Literals.ANY_TYPE)
    {
      // Don't cache this one as it will cause leaks because to dynamic demand
      // created document roots and demand created EClasses.
      //
...
final class XMLTypeFeatures
{
  ...
  public static final EStructuralFeature PROCESSING_INSTRUCTION = XMLTypePackage.eINSTANCE
      .getXMLTypeDocumentRoot_ProcessingInstruction();

  public static final FeatureMap.Entry.Internal TEXT_PROTOTYPE = ((EStructuralFeature.Internal)TEXT)
      .getFeatureMapEntryPrototype();

  public static final FeatureMap.Entry.Internal CDATA_PROTOTYPE = ((EStructuralFeature.Internal)CDATA)
      .getFeatureMapEntryPrototype();

  public static final FeatureMap.Entry.Internal COMMENT_PROTOTYPE = ((EStructuralFeature.Internal)COMMENT)
      .getFeatureMapEntryPrototype();

  public static final FeatureMap.Entry.Internal PROCESSING_INSTRUCTION_PROTOTYPE = ((EStructuralFeature.Internal)PROCESSING_INSTRUCTION)
      .getFeatureMapEntryPrototype();
}
