...
public class EObjectValidator implements EValidator
{
  ...
  public static String getObjectLabel(EObject eObject, Map<Object, Object> context)
  {
    if (context != null)
    {
      SubstitutionLabelProvider substitutionlabelProvider = (SubstitutionLabelProvider)context
          .get(SubstitutionLabelProvider.class);
  ...
  public boolean validate(EClass eClass, EObject eObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    else
    {
      ...
      return eSuperTypes.isEmpty() ? validate_EveryDefaultConstraint(eObject, diagnostics, context) : validate(
          eSuperTypes.get(0), eObject, diagnostics, context);
    }
  }

  protected boolean validate(int classifierID, Object object, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return classifierID != EcorePackage.EOBJECT
        || validate_EveryDefaultConstraint((EObject)object, diagnostics, context);
  }
      ...
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        if (size < lowerBound)
        {
          ...
          if (diagnostics != null)
          {
            diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE,
                EOBJECT__EVERY_MULTIPCITY_CONFORMS, getEcoreResourceLocator().getString(
                    ...
                    new Object[] { getFeatureLabel(eStructuralFeature, context), getObjectLabel(eObject, context),
                        new Integer(size), new Integer(lowerBound) }), new Object[] { eObject, eStructuralFeature }));
          }
        }
          ...
          if (diagnostics != null)
          {
            diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE,
                EOBJECT__EVERY_MULTIPCITY_CONFORMS, getEcoreResourceLocator().getString(
                    ...
                    new Object[] { getFeatureLabel(eStructuralFeature, context), getObjectLabel(eObject, context),
                        new Integer(size), new Integer(upperBound) }), new Object[] { eObject, eStructuralFeature }));
          }
        }
      }
      else
    ...
    {
      if (eStructuralFeature.isUnsettable() ? !eObject.eIsSet(eStructuralFeature) : eObject.eGet(eStructuralFeature,
          false) == null)
      {
        result = false;
        if (diagnostics != null)
        {
          diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, EOBJECT__EVERY_MULTIPCITY_CONFORMS,
              getEcoreResourceLocator().getString("_UI_RequiredFeatureMustBeSet_diagnostic",
                  new Object[] { getFeatureLabel(eStructuralFeature, context), getObjectLabel(eObject, context) }),
  ...
  {
    boolean result = true;
    for (EContentsEList.FeatureIterator<EObject> i = (EContentsEList.FeatureIterator<EObject>)eObject
        .eCrossReferences().iterator(); i.hasNext();)
    {
      ...
      if (eCrossReferenceObject.eIsProxy())
      {
        ...
        if (diagnostics != null)
        {
          diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, EOBJECT__EVERY_PROXY_RESOLVES,
              getEcoreResourceLocator().getString(
                  ...
                  new Object[] { getFeatureLabel(i.feature(), context), getObjectLabel(eObject, context),
                      getObjectLabel(eCrossReferenceObject, context) }), new Object[] { eObject, i.feature(),
    ...
    if (eObject.eResource() != null)
    {
          ...
          .eCrossReferences().iterator(); i.hasNext();)
      {
        ...
        if (eCrossReferenceObject.eResource() == null && !eCrossReferenceObject.eIsProxy()
            && !i.feature().isTransient())
        {
          result = false;
          if (diagnostics != null)
          {
            diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE,
                EOBJECT__EVERY_REFERENCE_IS_CONTAINED, getEcoreResourceLocator().getString(
  ...
  public boolean validate_EveryDataValueConforms(EObject eObject, DiagnosticChain diagnostics,
      Map<Object, Object> context)
  {
    boolean result = true;
  ...
  protected boolean validate_DataValueConforms(EObject eObject, EAttribute eAttribute, DiagnosticChain diagnostics,
      Map<Object, Object> context)
  {
            ...
            && ExtendedMetaData.INSTANCE.getAffiliation(eClass, entryFeature) == eAttribute)
        {
          ...
          if (!entryIsValid)
          {
            ...
            if (diagnostics != null)
            {
              ...
              {
                entryFeatureDiagnostic = createBadDataValueDiagnostic(eObject, (EAttribute)entryFeature, diagnostics,
                    context);
  ...
  protected DiagnosticChain createBadDataValueDiagnostic(EObject eObject, EAttribute eAttribute,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    BasicDiagnostic diagnostic = new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE,
        EOBJECT__EVERY_DATA_VALUE_CONFORMS, getEcoreResourceLocator().getString("_UI_BadDataValue_diagnostic",
            new Object[] { getFeatureLabel(eAttribute, context), getObjectLabel(eObject, context) }), new Object[] {
            eObject, eAttribute });
    ...
    public DynamicEDataTypeValidator(EDataType eDataType)
    {
      ...
      if (effectiveTotalDigits != -1 && eDataType.getInstanceClassName() != "java.math.BigDecimal")
      {
        ...
        boolean lowerBounded = effectiveMin == null
            || (effectiveMinIsInclusive ? ((Comparable<Object>)effectiveMin).compareTo(lowerBound) <= 0
        ...
        boolean upperBounded = effectiveMax == null
            || (effectiveMaxIsInclusive ? ((Comparable<Object>)effectiveMax).compareTo(upperBound) >= 0
    ...
    public boolean validate(EDataType eDataType, Object value, DiagnosticChain diagnostics, Map<Object, Object> context)
    {
      ...
      if (effectiveMinLength != -1)
      {
        int length = value instanceof String ? ((String)value).length()
            : value instanceof Object[] ? ((Object[])value).length : ((Collection<?>)value).size();
  ...
  protected void reportMinViolation(EDataType eDataType, Object value, Object bound, boolean isInclusive,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__VALUE_IN_RANGE,
        getEcoreResourceLocator().getString(
            isInclusive ? "_UI_MinInclusiveConstraint_diagnostic" : "_UI_MinExclusiveConstraint_diagnostic",
            new Object[] { getValueLabel(eDataType, value, context), isInclusive ? ">=" : ">",
                getValueLabel(eDataType, bound, context) }), new Object[] { value, bound,
            isInclusive ? Boolean.TRUE : Boolean.FALSE }));
  }

  protected void reportMaxViolation(EDataType eDataType, Object value, Object bound, boolean isInclusive,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__VALUE_IN_RANGE,
        getEcoreResourceLocator().getString(
            isInclusive ? "_UI_MaxInclusiveConstraint_diagnostic" : "_UI_MaxExclusiveConstraint_diagnostic",
            new Object[] { getValueLabel(eDataType, value, context), "<", getValueLabel(eDataType, bound, context) }),
        new Object[] { value, bound, isInclusive ? Boolean.TRUE : Boolean.FALSE }));
  }

  protected void reportMinLengthViolation(EDataType eDataType, Object value, int length, int bound,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__LENGTH_IN_RANGE,
        getEcoreResourceLocator()
            .getString(
                "_UI_MinLengthConstraint_diagnostic",
                new Object[] { getValueLabel(eDataType, value, context), Integer.toString(length),
                    Integer.toString(bound) }), new Object[] { value, eDataType, new Integer(length),
            new Integer(bound) }));
  }

  protected void reportMaxLengthViolation(EDataType eDataType, Object value, int length, int bound,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__LENGTH_IN_RANGE,
        getEcoreResourceLocator()
  ...
  protected void reportTotalDigitsViolation(EDataType eDataType, Object value, int totalDigits,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__TOTAL_DIGITS_IN_RANGE,
        getEcoreResourceLocator().getString("_UI_TotalDigitsConstraint_diagnostic",
            new Object[] { getValueLabel(eDataType, value, context), new Integer(totalDigits) }), new Object[] { value,
            eDataType, new Integer(totalDigits) }));
  }

  protected void reportFractionDigitsViolation(EDataType eDataType, Object value, int fractionDigits,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__TOTAL_DIGITS_IN_RANGE,
        getEcoreResourceLocator().getString("_UI_FractionDigitsConstraint_diagnostic",
            new Object[] { getValueLabel(eDataType, value, context), new Integer(fractionDigits) }), new Object[] {
            value, eDataType, new Integer(fractionDigits) }));
  }

  protected void reportEnumerationViolation(EDataType eDataType, Object value, Collection<?> values,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (i.hasNext())
    {
      valueLiterals = getEcoreResourceLocator().getString("_UI_ListHead_composition",
          new Object[] { getValueLabel(eDataType, i.next(), context) });
      while (i.hasNext())
      {
        valueLiterals = getEcoreResourceLocator().getString("_UI_ListTail_composition",
            new Object[] { valueLiterals, getValueLabel(eDataType, i.next(), context) });
      }
    }
    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__VALUE_IN_ENUMERATION,
        getEcoreResourceLocator().getString("_UI_EnumerationConstraint_diagnostic",
            new Object[] { getValueLabel(eDataType, value, context), valueLiterals }), new Object[] { value, eDataType,
            values }));
  }

  protected void reportDataValuePatternViolation(EDataType eDataType, Object value, PatternMatcher[] patterns,
      DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (patterns.length > 0)
    {
      ...
      {
        patternLiterals = getEcoreResourceLocator().getString("_UI_ListTail_composition",
            new Object[] { patternLiterals, patterns[i] });
      }
    }

    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__MATCHES_PATTERN,
        getEcoreResourceLocator().getString("_UI_PatternConstraint_diagnostic",
            new Object[] { getValueLabel(eDataType, value, context), patternLiterals }), new Object[] { value,
            eDataType, patterns }));
  }

  protected void reportDataValueTypeViolation(EDataType eDataType, Object value, DiagnosticChain diagnostics,
      Map<Object, Object> context)
  {
    diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, DATA_VALUE__TYPE_CORRECT,
        getEcoreResourceLocator().getString(
            "_UI_BadDataValueType_diagnostic",
            new Object[] { getValueLabel(eDataType, value, context),
                value == null ? "<null>" : value.getClass().getName(), eDataType.getInstanceClass().getName() }),
  ...
  public boolean validate_UniqueID(EObject eObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (id != null)
    {
      ...
      if (resource != null)
      {
        ...
        {
          // ...
          diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, EOBJECT__UNIQUE_ID,
              getEcoreResourceLocator().getString("_UI_DuplicateID_diagnostic",
   ...
   * @return whether every key is unique.
   */
  protected boolean validate_KeyUnique(EObject eObject, EReference eReference, DiagnosticChain diagnostics,
      Map<Object, Object> context)
  {
    boolean result = true;
    ...
    for (EObject value : values)
    {
      ...
      if (otherValue != null)
      {
        ...
        else
        {
          ...
          diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, EOBJECT__EVERY_KEY_UNIQUE,
              getEcoreResourceLocator().getString(
                  "_UI_DuplicateKey_diagnostic",
                  new Object[] { getFeatureLabel(eReference, context), uriFragmentSegment,
                      getObjectLabel(value, context), getObjectLabel(otherValue, context) }), new Object[] { eObject,
                  eReference, value, otherValue }));
        }
      }
    }
  ...
  public boolean validate_EveryMapEntryUnique(EObject eObject, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    {
      EStructuralFeature eStructuralFeature = eClass.getEStructuralFeature(i);
      if (eStructuralFeature.getEType().getInstanceClassName() == "java.util.Map$Entry"
   ...
   * @return whether every map entry is unique.
   */
  protected boolean validate_MapEntryUnique(EObject eObject, EReference eReference, DiagnosticChain diagnostics,
      Map<Object, Object> context)
  {
    boolean result = true;
    ...
    if (value instanceof EMap)
    {
      ...
      for (int i = 0, size = eMap.size(); i < size; ++i)
      {
        ...
        if (index != i)
        {
          ...
          {
            diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, DIAGNOSTIC_SOURCE, EOBJECT__EVERY_MAP_ENTRY_UNIQUE,
                getEcoreResourceLocator().getString("_UI_DuplicateMapEntry_diagnostic",
                    new Object[] { getFeatureLabel(eReference, context), i, index }), new Object[] { eObject,
                    eReference, entry, eMap.get(index) }));
          }
        }
      }
    }
