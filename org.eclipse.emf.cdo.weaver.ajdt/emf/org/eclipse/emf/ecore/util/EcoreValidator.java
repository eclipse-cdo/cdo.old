...
public class EcoreValidator extends EObjectValidator
{
  ...
  public boolean validateEAttribute(EAttribute eAttribute, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    {
      result &= validate_EveryDataValueConforms(eAttribute, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryReferenceIsContained(eAttribute, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eAttribute, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eAttribute, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eAttribute, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eAttribute, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
  ...
  /**
   * A well formed URI string must have a non-zero length, and must encode any special characters such as the space
   * character. As such, creating a {@link URI#createURI(String, boolean) URI}, ignoring the properly encoded
   * characters, and converting that to a {@link URI#toString() string}, must yield this URI string itself.
   * 
   * @param uri
  ...
  public boolean validateEClass(EClass eClass, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eClass, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryReferenceIsContained(eClass, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eClass, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eClass, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eClass, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eClass, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validateENamedElement_WellFormedName(eClass, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
  ...
  /**
   * Validates the InterfaceIsAbstract constraint of '<em>EClass</em>'. <!-- begin-user-doc --> A class that is an
   * interface must be abstract. <!-- end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  /**
   * Validates the AtMostOneID constraint of '<em>EClass</em>'. <!-- begin-user-doc --> There can be at most one
   * attribute that is an ID. <!-- end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  public boolean validateEClassifier(EClassifier eClassifier, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eClassifier, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryReferenceIsContained(eClassifier, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eClassifier, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eClassifier, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eClassifier, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eClassifier, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
  ...
  /**
   * Validates the UniqueTypeParameterNames constraint of '<em>EClassifier</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  public boolean validateEDataType(EDataType eDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eDataType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryReferenceIsContained(eDataType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eDataType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eDataType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eDataType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eDataType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validateENamedElement_WellFormedName(eDataType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
  ...
  public boolean validateEEnum(EEnum eEnum, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eEnum, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryReferenceIsContained(eEnum, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eEnum, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eEnum, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eEnum, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eEnum, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validateENamedElement_WellFormedName(eEnum, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      ...
      Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eEnumLiteral, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eEnumLiteral, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eEnumLiteral, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eEnumLiteral, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eEnumLiteral, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      ...
      Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eNamedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eNamedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eNamedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eNamedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eNamedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
  ...
  public boolean validateEOperation(EOperation eOperation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eOperation, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryReferenceIsContained(eOperation, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eOperation, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eOperation, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eOperation, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eOperation, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
    ...
    if (result || diagnostics != null)
    {
      result &= validateETypedElement_ValidType(eOperation, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
  ...
  /**
   * Validates the UniqueTypeParameterNames constraint of '<em>EOperation</em>'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  public boolean validateEPackage(EPackage ePackage, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(ePackage, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryReferenceIsContained(ePackage, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(ePackage, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(ePackage, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(ePackage, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(ePackage, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validateENamedElement_WellFormedName(ePackage, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
  ...
  /**
   * Validates the UniqueNsURIs constraint of '<em>EPackage</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  public boolean validateEParameter(EParameter eParameter, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eParameter, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryReferenceIsContained(eParameter, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eParameter, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eParameter, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eParameter, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eParameter, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
    ...
    if (result || diagnostics != null)
    {
      result &= validateETypedElement_ValidType(eParameter, diagnostics, context);
    }
    return result;
  }
  ...
  /**
   * Validates the ConsistentOpposite constraint of '<em>EReference</em>'. <!-- begin-user-doc --> An
   * {@link EReference#getEOpposite() opposite} is optional but if one exists, it must be a feature of this references's
   * {@link EReference#getEReferenceType() type}, it must have this reference as its opposite, and, if this feature is
   * {@link EStructuralFeature#isTransient() transient}, then the opposite must also be transient, must not
   * {@link EReference#isResolveProxies() resolve proxies}. or must be a {@link EReference#isContainment() containment},
   * <!-- end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  /**
   * Validates the SingleContainer constraint of '<em>EReference</em>'. <!-- begin-user-doc --> A
   * {@link EReference#isContainer() container} reference must have a upper bound of 1. <!-- end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  /**
   * Validates the ConsistentKeys constraint of '<em>EReference</em>'. <!-- begin-user-doc --> The
   * {@link EReference#getEKeys() keys} of a reference must be features of the reference's
   * {@link ETypedElement#getEType()}. <!-- end-user-doc -->
   * 
   * @generated NOT
   */
      ...
      Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eTypedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eTypedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eTypedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eTypedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eTypedElement, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
  ...
  /**
   * Validates the ValidLowerBound constraint of '<em>ETyped Element</em>'. <!-- begin-user-doc --> The
   * {@link ETypedElement#getLowerBound() lower bound} must be greater or equal to 0 <!-- end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  /**
   * Validates the ValidUpperBound constraint of '<em>ETyped Element</em>'. <!-- begin-user-doc --> The
   * {@link ETypedElement#getUpperBound() upper bound} must be either {@link ETypedElement#UNBOUNDED_MULTIPLICITY},
   * {@link ETypedElement#UNSPECIFIED_MULTIPLICITY}, or greater than 0. <!-- end-user-doc -->
   * 
   * @generated NOT
   */
  ...
  /**
   * Validates the ConsistentBounds constraint of '<em>ETyped Element</em>'. <!-- begin-user-doc --> The
   * {@link ETypedElement#getLowerBound() lower bound} must be less than or equal to the
   * {@link ETypedElement#getUpperBound() upper bound}, unless the upper bound is one of the two special values
   * {@link ETypedElement#UNBOUNDED_MULTIPLICITY} or {@link ETypedElement#UNSPECIFIED_MULTIPLICITY}. <!-- end-user-doc
   * -->
   * 
   * @generated NOT
   */
      ...
      Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryDataValueConforms(eGenericType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
    ...
    if (result || diagnostics != null)
    {
      result &= validate_EveryProxyResolves(eGenericType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_UniqueID(eGenericType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryKeyUnique(eGenericType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
      result &= validate_EveryMapEntryUnique(eGenericType, diagnostics, context);
    }
    if (result || diagnostics != null)
    {
   ...
   * to a {@link EClass class}. A generic type used as a {@link EGenericType#getETypeArguments() type argument} of a
   * generic type used as a generic super type must specify either a classifier or a type parameter, i.e., it can't be a
   * wildcard. A generic type may omit both the classifier and the type argument to act as a wildcard only when used as
   * a type argument of some generic type, with the above exception. If present, the classifier of generic type used as
   * the {@link ETypedElement#getEType() type} of an {@link EAttribute attribute} must be a {@link EDataType data type}.
   * If present, the classifier of generic type used as the type of a {@link EReference reference} must be a class. <!--
   * end-user-doc -->
   * 
   * @generated NOT
   */
      ...
      Map<Object, Object> context)
  {
    ...
    if (eTypeParameter != null)
    {
      ...
      if (inScope)
      {
        ...
        inScope = index == -1 || index > eTypeParameterIndex || index == eTypeParameterIndex
            && eGenericType.eContainingFeature() == EcorePackage.Literals.EGENERIC_TYPE__ETYPE_ARGUMENTS;
      }
  ...
  /**
   * Returns whether the generic type argument is a valid substitution for the type parameter. A generic type is a valid
   * substitution if it is {@link #isBounded(EGenericType, EGenericType, Map) bounded} by every
   * {@link ETypeParameter#getEBounds() bound} of the type parameter. It follows that for a type parameter without
   * bounds, every type argument is a valid substitution.
   * 
   * @param eTypeArgument
   ...
   * parameter must be bounded by bound. If the bound has a {@link EGenericType#getELowerBound() lower bound}, the
   * generic type argument must be bounded by that lower bound. If the bound has an
   * {@link EGenericType#getEUpperBound() upper bound}, the generic type argument must be bounded by that upper bound.
   * If the bound references a type parameter, the generic type argument must be bounded by every bound of that type
   * parameter. If the bound has a lower bound, the generic type argument must be bounded by it. If the bound has an
   * upper bound, the generic type argument must be bound that upper bound. Failing all these cases, the bound is a
   * wildcard with no constraint, and the type argument is bounded.
   * 
   * @param eGenericType
  ...
  public static class EGenericTypeBuilder
  {
    ...
    /**
     * Parses an instance type name and returns a diagnostic representing the result of the analysis. The
     * {@link Diagnostic#getData() data} of the diagnostic will contain as the first object, the resulting
    ...
    /**
     * Parses a list of type parameters and returns a diagnostic representing the result of the analysis. The
     * {@link Diagnostic#getData() data} of the diagnostic will contain as the first object, the resulting list of
    ...
    /**
     * Parses a type parameter and returns a diagnostic representing the result of the analysis. The
     * {@link Diagnostic#getData() data} of the diagnostic will contain as the first object, the resulting
    ...
    /**
     * Returns whether this code point is a valid part of an identifier, i.e., whether it's valid after the first
     * character.
     * 
     * @param codePoint
     *          the code point in question.
     ...
     * {@link #handleTypeArgument(char[], int, int, DiagnosticChain) well formed type arguments}. Whitespace before or
     * after arguments is ignored.
     * 
     * @param instanceTypeName
     *          the instance type name in question.
     * @param start
    ...
    /**
     * A well formed type argument must denote a valid Java type argument. It may start with a "?" which may be
     * optionally followed by the keyword "extends" or "super" which in turn, when present, must be followed by a
     * {@link #handleInstanceTypeName(char[], int, int, DiagnosticChain) well formed type instance name}. White space
     * before the keyword is optional but at least one space character is expected after the keyword. Otherwise, the
     * whole string must be a well formed instance type name.
     * 
     * @param instanceTypeName
     *          the instance type name in question.
     * @param start
