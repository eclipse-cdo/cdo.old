...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EEnum</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
{
  /**
   * Returns the value of the '<em><b>ELiterals</b></em>' containment
   * reference list. The list contents are of type
   * {@link org.eclipse.emf.ecore.EEnumLiteral}. It is bidirectional and its
   * opposite is '{@link org.eclipse.emf.ecore.EEnumLiteral#getEEnum <em>EEnum</em>}'.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * <!-- begin-user-doc --> Returns the enum literal with the given name, or
   * <code>null</code>.
   * 
   * @param name
   *          name in question.
  ...
  /**
   * <!-- begin-user-doc --> Returns the enum literal with the given value, or
   * <code>null</code>. The values may not be unique; it returns the first.
   * 
   * @param value
   *          value in question.
  ...
  /**
   * <!-- begin-user-doc --> Returns the enum literal with the given literal
