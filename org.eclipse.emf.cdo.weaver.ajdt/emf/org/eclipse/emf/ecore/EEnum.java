...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EEnum</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='UniqueEnumeratorNames
 *        UniqueEnumeratorLiterals'"
 * @generated
 */
public interface EEnum extends EDataType
{
  ...
  /**
   * <!-- begin-user-doc --> Returns the enum literal with the given name, or <code>null</code>.
   * 
   * @param name
   *          name in question.
   * @return the enum literal with the given name, or <code>null</code>. <!-- end-user-doc -->
   * @model
   * @generated
   */
   ...
   * @param value
   *          value in question.
   * @return the enum literal with the given value, or <code>null</code>. <!-- end-user-doc -->
   * @model
   * @generated
   */
  ...
  /**
   * <!-- begin-user-doc --> Returns the enum literal with the given literal value, or <code>null</code>.
   * 
   * @param literal
   *          literal in question.
   * @return the enum literal with the given literal value, or <code>null</code>. <!-- end-user-doc -->
   * @model
   * @generated
   */
