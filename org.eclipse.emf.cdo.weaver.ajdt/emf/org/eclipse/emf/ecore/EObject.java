...
public interface EObject extends Notifier
{
   ...
   * <p>
   * The meta class defines the {@link EClass#getEAllStructuralFeatures features} available for <a
  ...
  /**
   * <!-- begin-user-doc --> Returns the containing resource, or <code>null</code>.
   * <p>
   * An object is contained in a resource if it, or one of it's {@link #eContainer containers}, appears in the
   ...
   * <p>
   * An object is contained by another object if it appears in the {@link #eContents contents} of that object. The
   * object will be contained by a {@link #eContainmentFeature containment feature} of the containing object.
   * </p>
   * 
  ...
  /**
   * <!-- begin-user-doc --> Returns the particular {@link EClass#getEAllContainments feature} of the
   * {@link #eContainer container} that actually holds the object, or <code>null</code>, if there is no container.
   * Because of support for wildcard content, this feature may be an attribute representing a
   * {@link org.eclipse.emf.ecore.util.FeatureMap feature map}; in this case the object is referenced by the
   * {@link org.eclipse.emf.ecore.EReference#isContainment containment} feature of an
   * {@link org.eclipse.emf.ecore.util.FeatureMap.Entry#getEStructuralFeature entry} in the map, i.e., the
   * {@link #eContainmentFeature eContainmentFeature}.
   * <p>
   * 
  ...
  /**
   * <!-- begin-user-doc --> Returns the {@link org.eclipse.emf.ecore.EReference#isContainment containment} feature that
   * properly contains the object, or <code>null</code>, if there is no container. Because of support for wildcard
   * content, this feature may not be a direct feature of the container's {@link #eClass class}, but rather a
   * {@link org.eclipse.emf.ecore.util.FeatureMap.Entry#getEStructuralFeature feature} of an entry in a feature map
   * {@link #eContainingFeature feature} of the container's class.
   * <p>
   * 
  ...
  /**
   * <!-- begin-user-doc --> Returns a list view of the content objects; it is unmodifiable.
   * <p>
   * This will be the list of {@link EObject}s determined by the {@link #eGet(EStructuralFeature) contents} of the
   * {@link EClass#getEAllContainments containment features} of this object's {@link #eClass meta class}. Objects can,
   * {@link org.eclipse.emf.ecore.util.EcoreUtil#remove(EObject) indirectly}, be removed and will change to reflect
   * {@link #eContainer container} changes. The implicit {@link #eAllContents tree} of contents is also directly
   * available.
   * </p>
   * 
  ...
  /**
   * <!-- begin-user-doc --> Returns a tree iterator that iterates over all the {@link #eContents direct contents} and
   * indirect contents of this object.
   * 
  ...
  /**
   * <!-- begin-user-doc --> Returns the value of the given feature of this object.
   * <p>
  ...
  /**
   * <!-- begin-user-doc --> Returns the value of the given feature of the object; the value is optionally
  ...
  /**
   * <!-- begin-user-doc --> Sets the value of the given feature of the object to the new value.
   * <p>
   * If the feature is {@link ETypedElement#isMany() many-valued}, the new value must be an {@link EList} and each
   * object in that list must be {@link EClassifier#isInstance an instance of} the feature's
   * {@link ETypedElement#getEType() type}; the existing contents are cleared and the contents of the new value are
   * added. However, if the new value is the content list itself, or is modified as a side effect of modifying the
   * content list (i.e., if it is a view on the content list), the behavior is undefined and will likely result in
   * simply clearing the list. If the feature is single-valued, the new value directly must be an instance of the
   * feature's type and it becomes the new value of the feature of the object. If the feature is
   * {@link EStructuralFeature#isUnsettable() unsettable}, the modeled state becomes set; otherwise, the feature may
   * still not considered {@link #eIsSet set} if the new value is the same as the default.
   * 
   * @param feature
   ...
   * <p>
   * If the feature is {@link ETypedElement#isMany() many-valued}, the value must be an {@link EList} and that list is
   * cleared. Otherwise, the value of the feature of the object is set to the feature's
   * {@link EStructuralFeature#getDefaultValue() default value} or the {@link #eClass meta class}'s
   * {@link EStructuralFeature#getDefaultValue() default value}, as appropriate. If the feature is
   * {@link EStructuralFeature#isUnsettable() unsettable}, the modeled state becomes unset. In any case, the feature
   * will no longer be considered {@link #eIsSet set}.
   * </p>
   * 
   * @param feature
   *          the feature in question.
