 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='WellFormedNsURI WellFormedNsPrefix
...
public interface EPackage extends ENamedElement
{
  ...
  {
    /**
     * Looks up the value in the map, converting <code>EPackage.Descriptor</code> objects to <code>EPackage</code>
     * objects on demand.
     */
    EPackage getEPackage(String nsURI);

    /**
     * Looks up the value in the map, converting <code>EPackage.Descriptor</code> objects to <code>EFactory</code>
     * objects on demand.
     */
   ...
   * <p>
   * It represents the namespace URI, i.e., a universally unique identification of a particular package, much like an
   * XML Schema target namespace. It will be used in an XMI serialization. It is typically registered with the
