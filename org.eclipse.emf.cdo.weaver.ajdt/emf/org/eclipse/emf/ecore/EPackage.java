...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EPackage</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *        constraints='WellFormedNsURI WellFormedNsPrefix UniqueSubpackageNames
 *        UniqueClassifierNames UniqueNsURIs'"
 * @generated
 */
public interface EPackage extends ENamedElement
{
  /**
   * An <code>EPackage</code> wrapper that is used by the
  ...
  public interface Registry extends Map<String, Object>
  {
     ...
     * <code>EPackage.Descriptor</code> objects to <code>EPackage</code>
     * objects on demand.
     */
    ...
    /**
     * Looks up the value in the map, converting
     * <code>EPackage.Descriptor</code> objects to <code>EFactory</code>
     * objects on demand.
     */
   ...
   * begin-user-doc -->
   * <p>
   * It represents the namespace URI, i.e., a universally unique identification
   * of a particular package, much like an XML Schema target namespace. It will
   * be used in an XMI serialization. It is typically registered with the
   * {@link EPackage.Registry#INSTANCE global} package registry.
   * </p>
   * 
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.ecore.EPackage#getNsURI <em>Ns URI</em>}'
   ...
   * begin-user-doc -->
   * <p>
   * It represents the preferred XMLNS prefix to be used for this package's the
   * {@link #getNsURI namespace URI}. It will be used in an XMI serialization.
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.ecore.EPackage#getNsPrefix <em>Ns Prefix</em>}'
   * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
  ...
  /**
   * Returns the value of the '<em><b>EFactory Instance</b></em>'
   * reference. It is bidirectional and its opposite is '{@link org.eclipse.emf.ecore.EFactory#getEPackage <em>EPackage</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @model opposite="ePackage" resolveProxies="false" required="true"
   *        transient="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.ecore.EPackage#getEFactoryInstance <em>EFactory Instance</em>}'
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>EFactory Instance</em>' reference.
  ...
  /**
   * Returns the value of the '<em><b>EClassifiers</b></em>' containment
   * reference list. The list contents are of type
   * {@link org.eclipse.emf.ecore.EClassifier}. It is bidirectional and its
   * opposite is '{@link org.eclipse.emf.ecore.EClassifier#getEPackage <em>EPackage</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   * It represents the meta objects, i.e., classes and data types, defined in
   * this package.
   * </p>
   * <!-- end-user-doc -->
   * 
   * @return the value of the '<em>EClassifiers</em>' containment reference
   *         list.
  ...
  /**
   * Returns the value of the '<em><b>ESubpackages</b></em>' containment
   * reference list. The list contents are of type
   * {@link org.eclipse.emf.ecore.EPackage}. It is bidirectional and its
   * opposite is '{@link org.eclipse.emf.ecore.EPackage#getESuperPackage <em>ESuper Package</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- end-user-doc -->
   * 
   * @return the value of the '<em>ESubpackages</em>' containment reference
   *         list.
  ...
  /**
   * Returns the value of the '<em><b>ESuper Package</b></em>' container
   * reference. It is bidirectional and its opposite is '{@link org.eclipse.emf.ecore.EPackage#getESubpackages <em>ESubpackages</em>}'.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * <!-- begin-user-doc --> Returns the classifier with the given name.
   * 
   * @param name
   *          the name in question.
   * @return the classifier with the given name. <!-- end-user-doc -->
   * @model
   * @generated
   */
