...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Any Type</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface AnyType extends EObject
{
   ...
   *        volatile="true" derived="true" extendedMetaData="kind='elementWildcard' wildcards='##any' name=':1'
   *        processing='lax'"
   * @generated
   */
  FeatureMap getAny();
  ...
  /**
   * Returns the value of the '<em><b>Any Attribute</b></em>' attribute list. The list contents are of type
   * {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
