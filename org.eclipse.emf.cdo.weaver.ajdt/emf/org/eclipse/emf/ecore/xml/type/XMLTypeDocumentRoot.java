 ...
 * @model features="cDATA comment processingInstruction text" cDATAUnique="false"
 *        cDATADataType="org.eclipse.emf.ecore.xml.type.String" cDATAUpper="-2" cDATATransient="true"
 *        cDATAVolatile="true" cDATADerived="true" cDATASuppressedGetVisibility="true"
 *        cDATAExtendedMetaData="kind='element' name='cDATA' namespace='##targetNamespace'" commentUnique="false"
 *        commentDataType="org.eclipse.emf.ecore.xml.type.String" commentUpper="-2" commentTransient="true"
 *        commentVolatile="true" commentDerived="true" commentSuppressedGetVisibility="true"
 *        commentExtendedMetaData="kind='element' name='comment' namespace='##targetNamespace'"
 *        processingInstructionType="org.eclipse.emf.ecore.xml.type.ProcessingInstruction"
 *        processingInstructionContainment="true" processingInstructionUpper="-2" processingInstructionTransient="true"
 *        processingInstructionVolatile="true" processingInstructionDerived="true"
 *        processingInstructionSuppressedGetVisibility="true" processingInstructionExtendedMetaData="kind='element'
 *        name='processingInstruction' namespace='##targetNamespace'" textUnique="false"
 *        textDataType="org.eclipse.emf.ecore.xml.type.String" textUpper="-2" textTransient="true" textVolatile="true"
 *        textDerived="true" textSuppressedGetVisibility="true" textExtendedMetaData="kind='element' name='text'
 *        namespace='##targetNamespace'" extendedMetaData="name='' kind='mixed'"
 * @generated
 */
