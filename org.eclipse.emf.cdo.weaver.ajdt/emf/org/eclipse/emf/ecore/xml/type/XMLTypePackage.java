...
public interface XMLTypePackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link org.eclipse.emf.ecore.xml.type.impl.AnyTypeImpl <em>Any Type</em>}'
  ...
  /**
   * The number of structural features of the '<em>Processing Instruction</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The number of structural features of the '<em>Simple Any Type</em>'
   * class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='anyURI'
   *        whiteSpace='collapse'"
   * @generated
   */
  EDataType getAnyURI();
   ...
   * @model instanceClass="byte[]" extendedMetaData="name='base64Binary'
   *        whiteSpace='collapse'"
   * @generated
   */
   ...
   * @model instanceClass="boolean" extendedMetaData="name='boolean'
   *        whiteSpace='collapse'"
   * @generated
   */
   ...
   * @see java.lang.Long
   * @model instanceClass="java.lang.Long" extendedMetaData="name='long:Object'
   *        baseType='long'"
   * @generated
   */
   ...
   * @see java.lang.Byte
   * @model instanceClass="java.lang.Byte" extendedMetaData="name='byte:Object'
   *        baseType='byte'"
   * @generated
   */
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='string'
   *        whiteSpace='preserve'"
   * @generated
   */
  EDataType getString();
   ...
   * @model instanceClass="double" extendedMetaData="name='double'
   *        whiteSpace='collapse'"
   * @generated
   */
  EDataType getDouble();
   ...
   *        extendedMetaData="name='normalizedString' baseType='string'
   *        whiteSpace='replace'"
   * @generated
   */
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='token'
   *        baseType='normalizedString' whiteSpace='collapse'"
   * @generated
   */
  EDataType getToken();
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='Name'
   *        baseType='token' pattern='\\i\\c*'"
   * @generated
   */
  EDataType getName_();
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='NCName'
   *        baseType='Name' pattern='[\\i-[:]][\\c-[:]]*'"
   * @generated
   */
  EDataType getNCName();
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='ENTITY'
   *        baseType='NCName'"
   * @generated
   */
  EDataType getENTITY();
   ...
   * @see java.util.List
   * @model instanceClass="java.util.List" extendedMetaData="name='ENTITIES'
   *        baseType='ENTITIES_._base' minLength='1'"
   * @generated
   */
   ...
   * @model instanceClass="float" extendedMetaData="name='float'
   *        whiteSpace='collapse'"
   * @generated
   */
  EDataType getFloat();
   ...
   * @model instanceClass="byte[]" extendedMetaData="name='hexBinary'
   *        whiteSpace='collapse'"
   * @generated
   */
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='IDREF'
   *        baseType='NCName'"
   * @generated
   */
  EDataType getIDREF();
   ...
   * @see java.util.List
   * @model instanceClass="java.util.List" extendedMetaData="name='IDREFS'
   *        baseType='IDREFS_._base' minLength='1'"
   * @generated
   */
  EDataType getIDREFS();
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='language'
   *        baseType='token' pattern='[a-zA-Z]{1,8}(-[a-zA-Z0-9]{1,8})*'"
   * @generated
   */
   ...
   * @see java.math.BigInteger
   * @model instanceClass="java.math.BigInteger"
   *        extendedMetaData="name='nonPositiveInteger' baseType='integer'
   *        maxInclusive='0'"
   * @generated
   */
   ...
   * @see java.math.BigInteger
   * @model instanceClass="java.math.BigInteger"
   *        extendedMetaData="name='negativeInteger'
   *        baseType='nonPositiveInteger' maxInclusive='-1'"
   * @generated
   */
   ...
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='NMTOKEN'
   *        baseType='token' pattern='\\c+'"
   * @generated
   */
   ...
   * @see java.util.List
   * @model instanceClass="java.util.List" extendedMetaData="name='NMTOKENS'
   *        baseType='NMTOKENS_._base' minLength='1'"
   * @generated
   */
   ...
   * @see java.math.BigInteger
   * @model instanceClass="java.math.BigInteger"
   *        extendedMetaData="name='nonNegativeInteger' baseType='integer'
   *        minInclusive='0'"
   * @generated
   */
   ...
   * @see java.math.BigInteger
   * @model instanceClass="java.math.BigInteger"
   *        extendedMetaData="name='positiveInteger'
   *        baseType='nonNegativeInteger' minInclusive='1'"
   * @generated
   */
   ...
   * @see java.math.BigInteger
   * @model instanceClass="java.math.BigInteger"
   *        extendedMetaData="name='unsignedLong' baseType='nonNegativeInteger'
   ...
   * @model instanceClass="long" extendedMetaData="name='unsignedInt'
   *        maxInclusive='4294967295' minInclusive='0'"
   * @generated
   */
   ...
   * @model instanceClass="int" extendedMetaData="name='unsignedShort'
   *        maxInclusive='65535' minInclusive='0'"
   * @generated
   */
   ...
   * @see java.lang.Integer
   * @model instanceClass="java.lang.Integer"
   *        extendedMetaData="name='unsignedShort:Object'
   ...
   * @model instanceClass="short" extendedMetaData="name='unsignedByte'
   *        maxInclusive='255' minInclusive='0'"
   * @generated
   */
   ...
   * @see java.lang.Short
   * @model instanceClass="java.lang.Short"
   *        extendedMetaData="name='unsignedByte:Object'
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Raw Value</b></em>'
    ...
    /**
     * The meta object literal for the '<em><b>Instance Type</b></em>'
    ...
    /**
     * The meta object literal for the '<em><b>CDATA</b></em>' attribute
     * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em><b>Processing Instruction</b></em>'
    ...
    /**
     * The meta object literal for the '<em>Negative Integer</em>' data
    ...
    /**
     * The meta object literal for the '<em>Non Negative Integer</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.math.BigInteger
     * @see org.eclipse.emf.ecore.xml.type.impl.XMLTypePackageImpl#getNonNegativeInteger()
    ...
    /**
     * The meta object literal for the '<em>Non Positive Integer</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.math.BigInteger
     * @see org.eclipse.emf.ecore.xml.type.impl.XMLTypePackageImpl#getNonPositiveInteger()
    ...
    /**
     * The meta object literal for the '<em>Normalized String</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.lang.String
     * @see org.eclipse.emf.ecore.xml.type.impl.XMLTypePackageImpl#getNormalizedString()
    ...
    /**
     * The meta object literal for the '<em>Positive Integer</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.math.BigInteger
     * @see org.eclipse.emf.ecore.xml.type.impl.XMLTypePackageImpl#getPositiveInteger()
    ...
    /**
     * The meta object literal for the '<em>Unsigned Byte Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.lang.Short
     * @see org.eclipse.emf.ecore.xml.type.impl.XMLTypePackageImpl#getUnsignedByteObject()
    ...
    /**
     * The meta object literal for the '<em>Unsigned Int Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.lang.Long
     * @see org.eclipse.emf.ecore.xml.type.impl.XMLTypePackageImpl#getUnsignedIntObject()
    ...
    /**
     * The meta object literal for the '<em>Unsigned Short Object</em>' data
     * type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.lang.Integer
     * @see org.eclipse.emf.ecore.xml.type.impl.XMLTypePackageImpl#getUnsignedShortObject()
