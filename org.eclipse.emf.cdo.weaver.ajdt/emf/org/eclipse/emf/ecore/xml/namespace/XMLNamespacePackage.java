...
public interface XMLNamespacePackage extends EPackage
{
  ...
  /**
   * The meta object id for the '<em>Lang Type</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The meta object id for the '<em>Lang Type Null</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see java.lang.String
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.String <em>Lang Type</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @return the meta object for data type '<em>Lang Type</em>'.
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='lang_._type'
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.String <em>Lang Type Null</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @return the meta object for data type '<em>Lang Type Null</em>'.
   * @see java.lang.String
   * @model instanceClass="java.lang.String" extendedMetaData="name='lang_._type_._member_._1'
   *        baseType='http://www.eclipse.org/emf/2003/XMLType#string' enumeration=''"
   * @generated
   */
   ...
   * @see org.eclipse.emf.ecore.xml.namespace.SpaceType
   * @model instanceClass="org.eclipse.emf.ecore.xml.namespace.SpaceType" extendedMetaData="name='space_._type:Object'
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference XML_NAMESPACE_DOCUMENT_ROOT__XSI_SCHEMA_LOCATION = eINSTANCE
    ...
    /**
     * The meta object literal for the '<em><b>Space</b></em>' attribute feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '<em>Lang Type</em>' data type. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see java.lang.String
     * @see org.eclipse.emf.ecore.xml.namespace.impl.XMLNamespacePackageImpl#getLangType()
     * @generated
