...
public abstract class EStructuralFeatureImpl extends ETypedElementImpl implements EStructuralFeature,
    EStructuralFeature.Internal, BasicExtendedMetaData.EStructuralFeatureExtendedMetaData.Holder
{
    ...
    else if (eType instanceof EDataType)
    {
      ...
      if (factory != defaultValueFactory)
      {
        ...
        if (eDataType.isSerializable())
        {
          ...
          {
            // At development time, the real factory may not be available. Just
            // return null.
            //
            defaultValue = null;
          }
    ...
    if (settingDelegate == null)
    {
          ...
          if (eOpposite == null)
          {
            if (isUnsettable())
            {
              if (dataClass == null)
              {
                if (isResolveProxies())
                {
                  settingDelegate = new InternalSettingDelegateMany(
              ...
              else
              {
                ...
                {
                  settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.CONTAINMENT_UNSETTABLE,
                      dataClass, this);
                }
              }
            }
            else
            {
              if (dataClass == null)
              {
                if (isResolveProxies())
                {
                  settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.CONTAINMENT_DYNAMIC,
                      this);
                }
                else
                {
              ...
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.EMAP,
                    BasicEMap.Entry.class, this);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.CONTAINMENT, dataClass,
                    this);
              }
            }
          }
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.CONTAINMENT_INVERSE,
                      dataClass, this, eOpposite);
                }
              }
            }
          }
        ...
        else if (eType instanceof EDataType)
        {
          ...
          else if (isUnique())
          {
            if (isUnsettable())
            {
              ...
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.DATA_UNIQUE_UNSETTABLE,
                    dataClass, this);
              }
            }
            else
            {
              if (dataClass == null)
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.DATA_UNIQUE_DYNAMIC, this);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.DATA_UNIQUE, dataClass,
                    this);
              }
            }
          }
          else
          {
            if (isUnsettable())
            {
              if (dataClass == null)
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.DATA_UNSETTABLE_DYNAMIC,
                    this);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.DATA_UNSETTABLE,
                    dataClass, this);
              }
            }
            else
            {
              if (dataClass == null)
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.DATA_DYNAMIC, this);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.DATA, dataClass, this);
              }
            }
          }
        }
        else if (eOpposite == null)
        {
          if (isResolveProxies())
          {
            ...
            else
            {
              if (dataClass == null)
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.EOBJECT_RESOLVE_DYNAMIC,
                    this);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.EOBJECT_RESOLVE,
                    dataClass, this);
              }
            }
          }
          else
          {
            if (isUnsettable())
            {
              ...
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.EOBJECT_UNSETTABLE,
                    dataClass, this);
              }
            }
            else
            {
              if (dataClass == null)
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.EOBJECT_DYNAMIC, this);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.EOBJECT, dataClass, this);
              }
            }
          }
        }
        else if (eOpposite.isMany())
        {
          if (isResolveProxies())
          {
            ...
            else
            {
              ...
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.MANY_INVERSE_RESOLVE,
                    dataClass, this, eOpposite);
              }
            }
          }
          else
          {
            if (isUnsettable())
            {
              ...
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.MANY_INVERSE_UNSETTABLE,
                    dataClass, this, eOpposite);
              }
            }
            else
            {
              if (dataClass == null)
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.MANY_INVERSE_DYNAMIC,
                    this, eOpposite);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.MANY_INVERSE, dataClass,
                    this, eOpposite);
              }
            }
          }
        ...
        else
        {
          if (isResolveProxies())
          {
            ...
            else
            {
              if (dataClass == null)
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.INVERSE_RESOLVE_DYNAMIC,
                    this, eOpposite);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.INVERSE_RESOLVE,
                    dataClass, this, eOpposite);
              }
            }
          }
          else
          {
            if (isUnsettable())
            {
              ...
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.INVERSE_UNSETTABLE,
                    dataClass, this, eOpposite);
              }
            }
            else
            {
              if (dataClass == null)
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.INVERSE_DYNAMIC, this,
                    eOpposite);
              }
              else
              {
                settingDelegate = new InternalSettingDelegateMany(InternalSettingDelegateMany.INVERSE, dataClass, this,
                    eOpposite);
              }
            }
          }
      ...
      else if (eType instanceof EDataType)
      {
        ...
        else if (isUnsettable())
        {
          if (dataClass == null)
          {
            settingDelegate = new InternalSettingDelegateSingleDataUnsettableDynamic((EDataType)eType, defaultValue,
                intrinsicDefaultValue, this);
          }
          else
          {
            settingDelegate = new InternalSettingDelegateSingleDataUnsettableStatic(dataClass, defaultValue,
                intrinsicDefaultValue, this);
          }
        }
        else
        {
          if (dataClass == null)
          {
            settingDelegate = new InternalSettingDelegateSingleDataDynamic((EDataType)eType, defaultValue,
                intrinsicDefaultValue, this);
          }
          else
          {
            settingDelegate = new InternalSettingDelegateSingleDataStatic(dataClass, defaultValue,
                intrinsicDefaultValue, this);
          }
        }
      }
      else if (isContainment())
      {
        if (eOpposite == null)
        {
          if (isUnsettable())
          {
            if (isResolveProxies())
            {
              settingDelegate = new InternalSettingDelegateSingleEObjectContainmentUnsettableResolving((EClass)eType,
                  this);
            }
            else
            {
        ...
        else
        {
          if (isUnsettable())
          {
            if (isResolveProxies())
            {
              settingDelegate = new InternalSettingDelegateSingleEObjectContainmentWithInverseUnsettableResolving(
                  (EClass)eType, this, eOpposite);
            }
            else
            {
              settingDelegate = new InternalSettingDelegateSingleEObjectContainmentWithInverseUnsettable((EClass)eType,
                  this, eOpposite);
            }
          }
          else
          {
            if (isResolveProxies())
            {
              settingDelegate = new InternalSettingDelegateSingleEObjectContainmentWithInverseResolving((EClass)eType,
                  this, eOpposite);
            }
            else
            {
              settingDelegate = new InternalSettingDelegateSingleEObjectContainmentWithInverse((EClass)eType, this,
                  eOpposite);
            }
          }
        }
      ...
      else if (isResolveProxies())
      {
        ...
        else
        {
          if (isUnsettable())
          {
            settingDelegate = new InternalSettingDelegateSingleEObjectResolvingWithInverseUnsettable((EClass)eType,
                this, eOpposite);
          }
          else
          {
            settingDelegate = new InternalSettingDelegateSingleEObjectResolvingWithInverse((EClass)eType, this,
                eOpposite);
          }
        }
      }
      else
      {
        ...
        else
        {
          if (isUnsettable())
          {
            settingDelegate = new InternalSettingDelegateSingleEObjectWithInverseUnsettable((EClass)eType, this,
                eOpposite);
          }
          else
          {
  ...
  public static class InternalSettingDelegateFeatureMapDelegator implements EStructuralFeature.Internal.SettingDelegate
  {
    ...
    public Object dynamicGet(InternalEObject owner, EStructuralFeature.Internal.DynamicValueHolder settings, int index,
    ...
    public void dynamicSet(InternalEObject owner, EStructuralFeature.Internal.DynamicValueHolder settings, int index,
        Object newValue)
    {
      FeatureMap.Internal featureMap = (FeatureMap.Internal)owner.eGet(featureMapFeature);
    ...
    public NotificationChain dynamicInverseAdd(InternalEObject owner,
        EStructuralFeature.Internal.DynamicValueHolder settings, int index, InternalEObject otherEnd,
  ...
  public static class InternalSettingDelegateMany implements EStructuralFeature.Internal.SettingDelegate
  {
    ...
    protected EStructuralFeature.Setting createDynamicSetting(InternalEObject owner)
    {
      ...
      case CONTAINMENT_UNSETTABLE_RESOLVE:
        return new EObjectContainmentEList.Unsettable.Resolving<Object>(dataClass, owner, owner.eClass().getFeatureID(
            feature));
      case CONTAINMENT:
      ...
      case EMAP:
        return new EcoreEMap<Object, Object>((EClass)feature.getEType(), dataClass, owner, owner.eClass().getFeatureID(
            feature));
      case CONTAINMENT_INVERSE_UNSETTABLE:
        return new EObjectContainmentWithInverseEList.Unsettable<Object>(dataClass, owner, owner.eClass().getFeatureID(
            feature), inverseFeature.getFeatureID());
      case CONTAINMENT_INVERSE_UNSETTABLE_RESOLVE:
        return new EObjectContainmentWithInverseEList.Unsettable.Resolving<Object>(dataClass, owner, owner.eClass()
            .getFeatureID(feature), inverseFeature.getFeatureID());
      case CONTAINMENT_INVERSE:
        return new EObjectContainmentWithInverseEList<Object>(dataClass, owner, owner.eClass().getFeatureID(feature),
            inverseFeature.getFeatureID());
      case CONTAINMENT_INVERSE_RESOLVE:
        return new EObjectContainmentWithInverseEList.Resolving<Object>(dataClass, owner, owner.eClass().getFeatureID(
            feature), inverseFeature.getFeatureID());
      ...
      case MANY_INVERSE_RESOLVE_UNSETTABLE:
        return new EObjectWithInverseResolvingEList.Unsettable.ManyInverse<Object>(dataClass, owner, owner.eClass()
            .getFeatureID(feature), inverseFeature.getFeatureID());
      case MANY_INVERSE_RESOLVE:
        return new EObjectWithInverseResolvingEList.ManyInverse<Object>(dataClass, owner, owner.eClass().getFeatureID(
            feature), inverseFeature.getFeatureID());
      case MANY_INVERSE_UNSETTABLE:
        return new EObjectWithInverseEList.Unsettable.ManyInverse<Object>(dataClass, owner, owner.eClass()
            .getFeatureID(feature), inverseFeature.getFeatureID());
      case MANY_INVERSE:
        return new EObjectWithInverseEList.ManyInverse<Object>(dataClass, owner, owner.eClass().getFeatureID(feature),
            inverseFeature.getFeatureID());
      case INVERSE_RESOLVE_UNSETTABLE:
        return new EObjectWithInverseResolvingEList.Unsettable<Object>(dataClass, owner, owner.eClass().getFeatureID(
            feature), inverseFeature.getFeatureID());
      case INVERSE_RESOLVE:
        return new EObjectWithInverseResolvingEList<Object>(dataClass, owner, owner.eClass().getFeatureID(feature),
            inverseFeature.getFeatureID());
      case INVERSE_UNSETTABLE:
        return new EObjectWithInverseEList.Unsettable<Object>(dataClass, owner, owner.eClass().getFeatureID(feature),
            inverseFeature.getFeatureID());
      case INVERSE:
        return new EObjectWithInverseEList<Object>(dataClass, owner, owner.eClass().getFeatureID(feature),
            inverseFeature.getFeatureID());
      case FEATURE_MAP:
        ...
        EStructuralFeature.Internal.DynamicValueHolder settings, int index)
    {
      ...
      {
        @SuppressWarnings("unchecked")
        List<Object> result = (List<Object>)settings.dynamicGet(index);
        ...
        boolean resolve, boolean coreType)
    {
      ...
      if (!coreType)
      {
        ...
        {
        case EMAP:
          return ((EMap<?, ?>)result).map();
        case FEATURE_MAP:
          return ((FeatureMap.Internal)result).getWrapper();
        }
      }
      return result;
    }
        ...
        NotificationChain notifications)
    {
      ...
      @SuppressWarnings("unchecked")
      NotificationChain result = ((InternalEList<InternalEObject>)setting).basicAdd(otherEnd, notifications);
      return result;
    }
  ...
  public static abstract class InternalSettingDelegateSingle implements EStructuralFeature.Internal.SettingDelegate
  {
    ...
    public EStructuralFeature.Setting dynamicSetting(final InternalEObject owner,
        final EStructuralFeature.Internal.DynamicValueHolder settings, final int index)
    {
  ...
  public static class InternalSettingDelegateSingleContainer extends InternalSettingDelegateSingle
  {
    ...
    public Object dynamicGet(InternalEObject owner, EStructuralFeature.Internal.DynamicValueHolder settings, int index,
        boolean resolve, boolean coreType)
    {
      return owner.eContainmentFeature() == inverseFeature ? isResolveProxies() && resolve ? owner.eContainer() : owner
        ...
        Object newValue)
    {
      ...
      if (newValue != eContainer || owner.eContainerFeatureID() != featureID && newValue != null)
      {
        ...
        if (newValue != null)
        {
          notifications = internalEObject.eInverseAdd(owner, internalEObject.eClass().getFeatureID(inverseFeature),
              null, notifications);
        }
  ...
  {
    public InternalSettingDelegateSingleContainerResolving(EClass eClass, EStructuralFeature feature,
        EReference inverseFeature)
    {
  ...
  public static class InternalSettingDelegateSingleData extends InternalSettingDelegateSingle
  {
    ...
    public InternalSettingDelegateSingleData(Object defaultValue, Object intrinsicDefaultValue,
        ...
        Object newValue)
    {
      if (owner.eNotificationRequired())
      {
        ...
        owner.eNotify(new ENotificationImpl(owner, Notification.SET, feature, oldValue, newValue));
      }
      else
      {
        if (newValue == null)
  ...
  public static class InternalSettingDelegateSingleDataDynamic extends InternalSettingDelegateSingleData
  {
    ...
    public InternalSettingDelegateSingleDataDynamic(EDataType eDataType, Object defaultValue,
        Object intrinsicDefaultValue, EStructuralFeature feature)
    {
  ...
  public static class InternalSettingDelegateSingleDataStatic extends InternalSettingDelegateSingleData
  {
    ...
    public InternalSettingDelegateSingleDataStatic(Class<?> dataClass, Object defaultValue,
        Object intrinsicDefaultValue, EStructuralFeature feature)
    {
      super(defaultValue, intrinsicDefaultValue, feature);
      this.dataClass = dataClass;
  ...
  {
    public InternalSettingDelegateSingleDataUnsettable(Object defaultValue, Object intrinsicDefaultValue,
        EStructuralFeature feature)
    {
      super(defaultValue, intrinsicDefaultValue, feature);
    }
        ...
        Object newValue)
    {
      if (owner.eNotificationRequired())
      {
        ...
        owner.eNotify(new ENotificationImpl(owner, Notification.SET, feature, oldValue, newValue, !oldIsSet));
      }
      else
      {
        if (newValue == null)
  ...
  public static class InternalSettingDelegateSingleDataUnsettableDynamic extends
      InternalSettingDelegateSingleDataUnsettable
  {
    protected EDataType eDataType;

    public InternalSettingDelegateSingleDataUnsettableDynamic(EDataType eDataType, Object defaultValue,
        Object intrinsicDefaultValue, EStructuralFeature feature)
    {
      super(defaultValue, intrinsicDefaultValue, feature);
      this.eDataType = eDataType;
  ...
  public static class InternalSettingDelegateSingleDataUnsettableStatic extends
      InternalSettingDelegateSingleDataUnsettable
  {
    protected Class<?> dataClass;

    public InternalSettingDelegateSingleDataUnsettableStatic(Class<?> dataClass, Object defaultValue,
        Object intrinsicDefaultValue, EStructuralFeature feature)
    {
      super(defaultValue, intrinsicDefaultValue, feature);
      this.dataClass = dataClass;
  ...
  public static class InternalSettingDelegateSingleEObject extends InternalSettingDelegateSingle
  {
      ...
      else if (isResolveProxies() && resolve && result != null)
      {
        ...
        if (oldEObject.eIsProxy())
        {
          ...
          if (oldEObject != resolvedEObject)
          {
            ...
            {
              throw new ClassCastException("The value of type '" + resolvedEObject.getClass() + "' must be of type '"
                  + eClass + "'");
            }
            ...
            if (isContainment())
            {
              ...
              {
                notificationChain = newEObject.eInverseAdd(owner,
                    inverseFeature == null ? InternalEObject.EOPPOSITE_FEATURE_BASE
                        - owner.eClass().getFeatureID(feature) : newEObject.eClass().getFeatureID(inverseFeature),
                    null, notificationChain);
              }
            ...
            if (owner.eNotificationRequired())
            {
              owner.eNotify(new ENotificationImpl(owner, Notification.RESOLVE, feature, oldEObject, resolvedEObject));
            }
          }
        }
        ...
        Object newValue)
    {
      ...
      if (hasInverse())
      {
        if (oldValue != newValue)
        {
          if (oldValue != null)
          {
            ...
            notifications = internalEObject.eInverseRemove(owner,
                internalEObject.eClass().getFeatureID(inverseFeature), null, notifications);
          }
          if (newValue != null)
          {
            InternalEObject internalEObject = (InternalEObject)newValue;
      ...
      else if (isContainment())
      {
        if (oldValue != newValue)
        {
          if (oldValue != null)
          {
            notifications = ((InternalEObject)oldValue).eInverseRemove(owner, InternalEObject.EOPPOSITE_FEATURE_BASE
                - owner.eClass().getFeatureID(feature), null, notifications);
          }
          if (newValue != null)
          {
            notifications = ((InternalEObject)newValue).eInverseAdd(owner, InternalEObject.EOPPOSITE_FEATURE_BASE
                - owner.eClass().getFeatureID(feature), null, notifications);
          }
        }
      }
      ...
      if (owner.eNotificationRequired())
      {
        Notification notification = new ENotificationImpl(owner, Notification.SET, feature, oldValue, newValue,
    ...
    public void dynamicUnset(InternalEObject owner, EStructuralFeature.Internal.DynamicValueHolder settings, int index)
    {
      ...
      if (oldValue != null)
      {
        ...
        {
          InternalEObject internalEObject = (InternalEObject)oldValue;
          notifications = internalEObject.eInverseRemove(owner, internalEObject.eClass().getFeatureID(inverseFeature),
              null, notifications);
        }
        else if (isContainment())
        {
      ...
      if (owner.eNotificationRequired())
      {
        Notification notification = new ENotificationImpl(owner,
            isUnsettable() ? Notification.UNSET : Notification.SET, feature, oldValue, null);
        if (notifications == null)
        {
          owner.eNotify(notification);
        }
  ...
  {
    public InternalSettingDelegateSingleEObjectWithInverse(EClass eClass, EStructuralFeature feature,
        EReference inverseFeature)
    {
      super(eClass, feature, inverseFeature);
    }
  ...
  public static class InternalSettingDelegateSingleEObjectWithInverseUnsettable extends
      InternalSettingDelegateSingleEObjectWithInverse
  {
    public InternalSettingDelegateSingleEObjectWithInverseUnsettable(EClass eClass, EStructuralFeature feature,
        EReference inverseFeature)
    {
      super(eClass, feature, inverseFeature);
    }
  ...
  public static class InternalSettingDelegateSingleEObjectContainmentResolving extends
  ...
  public static class InternalSettingDelegateSingleEObjectContainmentWithInverse extends
      InternalSettingDelegateSingleEObjectContainment
  {
    public InternalSettingDelegateSingleEObjectContainmentWithInverse(EClass eClass, EStructuralFeature feature,
        EReference inverseFeature)
    {
      super(eClass, feature, inverseFeature);
    }
  ...
  public static class InternalSettingDelegateSingleEObjectContainmentWithInverseResolving extends
      InternalSettingDelegateSingleEObjectContainmentWithInverse
  {
    public InternalSettingDelegateSingleEObjectContainmentWithInverseResolving(EClass eClass,
        EStructuralFeature feature, EReference inverseFeature)
    {
      super(eClass, feature, inverseFeature);
    }
  ...
  public static class InternalSettingDelegateSingleEObjectContainmentUnsettable extends
      InternalSettingDelegateSingleEObjectContainment
  {
  ...
  public static class InternalSettingDelegateSingleEObjectContainmentUnsettableResolving extends
  ...
  public static class InternalSettingDelegateSingleEObjectContainmentWithInverseUnsettable extends
      InternalSettingDelegateSingleEObjectContainmentWithInverse
  {
    public InternalSettingDelegateSingleEObjectContainmentWithInverseUnsettable(EClass eClass,
        EStructuralFeature feature, EReference inverseFeature)
    {
      super(eClass, feature, inverseFeature);
    }
  ...
  public static class InternalSettingDelegateSingleEObjectContainmentWithInverseUnsettableResolving extends
      InternalSettingDelegateSingleEObjectContainmentWithInverseUnsettable
  {
    public InternalSettingDelegateSingleEObjectContainmentWithInverseUnsettableResolving(EClass eClass,
        EStructuralFeature feature, EReference inverseFeature)
    {
      super(eClass, feature, inverseFeature);
    }
  ...
  public static class InternalSettingDelegateSingleEObjectResolvingUnsettable extends
  ...
  public static class InternalSettingDelegateSingleEObjectResolvingWithInverse extends
      InternalSettingDelegateSingleEObjectResolving
  {
    public InternalSettingDelegateSingleEObjectResolvingWithInverse(EClass eClass, EStructuralFeature feature,
        EReference inverseFeature)
    {
      super(eClass, feature, inverseFeature);
    }
  ...
  public static class InternalSettingDelegateSingleEObjectResolvingWithInverseUnsettable extends
      InternalSettingDelegateSingleEObjectResolvingWithInverse
  {
    public InternalSettingDelegateSingleEObjectResolvingWithInverseUnsettable(EClass eClass,
        EStructuralFeature feature, EReference inverseFeature)
    {
      super(eClass, feature, inverseFeature);
    }
  ...
  public static class SettingMany implements EStructuralFeature.Setting
  {
    ...
    public boolean isSet()
    {
      return list instanceof InternalEList.Unsettable ? ((InternalEList.Unsettable<Object>)list).isSet() : !list
          .isEmpty();
    }
  ...
  public boolean isFeatureMap()
  {
    if (cachedEType != eType)
    {
      ...
      cachedIsFeatureMap = eType != null
          && eType.getInstanceClassName() == "org.eclipse.emf.ecore.util.FeatureMap$Entry";
    }
  ...
  public static abstract class BasicFeatureMapEntry implements FeatureMap.Entry.Internal
  {
    ...
    public String toString()
    {
      ...
      return (prefix != null && prefix.length() != 0 ? prefix + ":" + eStructuralFeature.getName() : eStructuralFeature
          .getName())
          + "=" + getValue();
    }
  }
  ...
  public final static class SimpleFeatureMapEntry extends BasicFeatureMapEntry
  {
    ...
    public final NotificationChain inverseRemove(InternalEObject owner, Object otherEnd, int featureID,
        NotificationChain notifications)
    {
      return notifications;
    }
  ...
  public final class InverseUpdatingFeatureMapEntry extends BasicFeatureMapEntry
  {
        ...
        NotificationChain notifications)
    {
      if (otherEnd != null)
      {
        notifications = otherEnd.eInverseAdd(owner, otherEnd.eClass().getFeatureID(eStructuralFeature.getEOpposite()),
            null, notifications);
      }
        ...
        NotificationChain notifications)
    {
      if (otherEnd != null)
      {
        notifications = otherEnd.eInverseRemove(owner, otherEnd.eClass()
            .getFeatureID(eStructuralFeature.getEOpposite()), null, notifications);
      }
      return notifications;
    }
  }
  ...
  public void setExtendedMetaData(
      BasicExtendedMetaData.EStructuralFeatureExtendedMetaData eStructuralFeatureExtendedMetaData)
  {
