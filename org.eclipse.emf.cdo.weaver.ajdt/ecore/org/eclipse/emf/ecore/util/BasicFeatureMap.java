    ...
    FeatureMap.Internal.Wrapper
{
  ...
  protected Entry validate(int index, Entry object)
  {
    ...
    {
      throw new RuntimeException("Invalid entry feature '" + eStructuralFeature.getEContainingClass().getName() + "."
  ...
  protected NotificationImpl createNotification(int eventType, EStructuralFeature feature, Object oldObject,
  ...
  public Object resolveProxy(EStructuralFeature feature, int entryIndex, int index, Object object)
  {
    ...
    if (resolved != object)
    {
      ...
      {
        NotificationImpl notifications = createNotification(Notification.RESOLVE, entry.getEStructuralFeature(),
            object, resolved, index, false);
  ...
  public NotificationChain shadowSet(Entry oldObject, Entry newObject, NotificationChain notifications)
  {
    if (isNotificationRequired())
    {
      ...
      NotificationImpl notification = createNotification(Notification.SET, feature, oldValue, newValue, feature
          .isMany() ? indexOf(feature, newValue) : Notification.NO_INDEX, true);
  ...
  public NotificationChain inverseTouch(Object object, NotificationChain notifications)
  {
    if (isNotificationRequired())
    {
      ...
      EStructuralFeature feature = entry.getEStructuralFeature();
      Object value = entry.getValue();
      NotificationImpl notification = createNotification(Notification.SET, feature, value, value,
          feature.isMany() ? indexOf(feature, value) : Notification.NO_INDEX, true);
  ...
  public Entry move(int targetIndex, int sourceIndex)
  {
    ...
    else if (targetIndex != sourceIndex)
    {
      ...
      if (isMany(feature))
      {
        ...
        {
          dispatchNotification(new ENotificationImpl(owner, Notification.MOVE, feature,
              new Integer(featureSourceIndex), sourceEntry.getValue(), featureTargetIndex));
        }
        return result;
      }
    }
  ...
  {
    return feature instanceof EReference && ((EReference)feature).isResolveProxies() ? new ResolvingFeatureEIterator<Object>(
        feature, this)
  ...
  {
    ListIterator<Object> result = feature instanceof EReference && ((EReference)feature).isResolveProxies() ? new ResolvingFeatureEIterator<Object>(
        feature, this)
        : new FeatureEIterator<Object>(feature, this);
  ...
  {
    return FeatureMapUtil.isFeatureMap(feature) ? (EList<T>)new FeatureMapUtil.FeatureFeatureMap(feature, this)
        : new FeatureMapUtil.FeatureEList<T>(feature, this);
  }

  public EStructuralFeature.Setting setting(EStructuralFeature feature)
  {
    return isMany(feature) ? (EStructuralFeature.Setting)list(feature)
  ...
  public boolean addAll(int index, EStructuralFeature feature, Collection<?> collection)
  {
    ...
    boolean isFeatureMap = FeatureMapUtil.isFeatureMap(feature);
    @SuppressWarnings("unchecked")
    Collection<Entry> entryCollection = isFeatureMap ? (Collection<Entry>)collection : new BasicEList<Entry>(collection
        .size());
    if (isMany(feature))
    {
      if (feature.isUnique())
  ...
  public NotificationChain basicRemove(EStructuralFeature feature, Object object, NotificationChain notifications)
  {
    ...
    if (match != null)
    {
      if (isNotificationRequired())
      {
        NotificationImpl notification = feature.isMany() ? createNotification(Notification.REMOVE, feature, object,
            null, count, true) : createNotification(feature.isUnsettable() ? Notification.UNSET : Notification.SET,
            feature, object, feature.getDefaultValue(), Notification.NO_INDEX, true);
  ...
  public void clear(EStructuralFeature feature)
  {
    ...
    if (!removeAll(entryCollection) && owner.eNotificationRequired())
    {
      dispatchNotification(feature.isMany() ? createNotification(Notification.REMOVE_MANY, feature,
          ...
          feature.isUnsettable() ? Notification.UNSET : Notification.SET, feature, null, null, Notification.NO_INDEX,
          false));
    }
  }
  ...
  public Object move(EStructuralFeature feature, int targetIndex, int sourceIndex)
  {
    if (isMany(feature))
    {
      ...
      if (isNotificationRequired())
      {
        dispatchNotification(createNotification(Notification.MOVE, feature, new Integer(sourceIndex), result,
            targetIndex, true));
      }
  ...
  public NotificationChain basicRemove(Object object, NotificationChain notifications)
  {
    ...
    else
    {
      ...
      if (match != null)
      {
        ...
        {
          NotificationImpl notification = feature.isMany() ? createNotification(Notification.REMOVE, feature, object,
              null, indexOf(feature, object), true) : createNotification(feature.isUnsettable() ? Notification.UNSET
              : Notification.SET, feature, object, feature.getDefaultValue(), Notification.NO_INDEX, true);
  ...
  public static class FeatureMapEObjectImpl extends org.eclipse.emf.ecore.impl.EObjectImpl
  {
        ...
        NotificationChain notifications)
    {
      ...
      else
      {
        ...
        if (oldValue != null)
        {
          notifications = oldValue.eInverseRemove(this, oldValue.eClass().getFeatureID(
              ((EReference)feature).getEOpposite()), null, notifications);
