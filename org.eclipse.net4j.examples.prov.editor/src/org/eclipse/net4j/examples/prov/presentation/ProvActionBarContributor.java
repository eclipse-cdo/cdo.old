...
/**
 * This is the action bar contributor for the Prov model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProvActionBarContributor extends EditingDomainActionBarContributor implements
        ISelectionChangedListener
{
   ...
   * @generated
   */
  protected IAction showPropertiesViewAction = new Action(ProvEditorPlugin.INSTANCE
   ...
   * @generated
   */
  protected IAction refreshViewerAction = new Action(ProvEditorPlugin.INSTANCE
   ...
   * @generated
   */
  public ProvActionBarContributor()
  {
  ...
  {
    toolBarManager.add(new Separator("prov-settings"));
    toolBarManager.add(new Separator("prov-additions"));
  }
  ...
  public void contributeToMenu(IMenuManager menuManager)
  {
    ...
    IMenuManager submenuManager = new MenuManager(ProvEditorPlugin.INSTANCE
            .getString("_UI_ProvEditor_menu"), "org.eclipse.net4j.examples.provMenuID");
    ...
    //
    createChildMenuManager = new MenuManager(ProvEditorPlugin.INSTANCE
            .getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    createSiblingMenuManager = new MenuManager(ProvEditorPlugin.INSTANCE
  ...
  public void menuAboutToShow(IMenuManager menuManager)
  {
    ...
    submenuManager = new MenuManager(ProvEditorPlugin.INSTANCE
            .getString("_UI_CreateChild_menu_item"));
