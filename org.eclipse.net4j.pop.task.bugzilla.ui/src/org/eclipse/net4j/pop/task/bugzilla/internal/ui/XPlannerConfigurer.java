...
import org.eclipse.net4j.pop.task.internal.bugzilla.XPlannerConnector;
 ...
 * @author Eike Stepper
 */
public class XPlannerConfigurer extends TaskRepositoryConfigurer
{
  private static final String NAME = XPlannerConnector.NAME;

  public XPlannerConfigurer()
  {
    super(NAME);
  }
