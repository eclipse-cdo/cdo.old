 ...
 *
 * $Id: DevelopmentStreamItemProvider.java,v 1.1 2008-08-08 10:10:37 estepper Exp $
 */
    ...
    IItemColorProvider, IItemFontProvider
{
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ProjectPackage.Literals.DEVELOPMENT_STREAM__MAINTENANCE_STREAMS);
    }
  ...
  {
    PopProject popProject = ((DevelopmentStream)object).getPopProject();
    String label = popProject == null ? null : popProject.getName();
    return label == null || label.length() == 0 ? getString("_UI_DevelopmentStream_type") : //$NON-NLS-1$
        label + " Development"; //$NON-NLS-1$
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(DevelopmentStream.class))
    {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add(createChildParameter(ProjectPackage.Literals.DEVELOPMENT_STREAM__MAINTENANCE_STREAMS,
        ProjectFactory.eINSTANCE.createMaintenanceStream()));
  }
