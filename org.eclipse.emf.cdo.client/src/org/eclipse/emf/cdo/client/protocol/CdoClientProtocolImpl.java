...
public class CdoClientProtocolImpl extends AbstractCdoProtocol
{
  ...
  private static void postProcessNewResources(Channel channel)
  {
    ...
    for (Iterator iter = resources.iterator(); iter.hasNext();)
    {
      ...
      if (resource instanceof CdoResource)
      {
        ...
        {
          String path = CdoClientProtocolImpl.requestResourceRid(channel, cdoResource.getRid());
          ...
          CdoClientProtocolImpl.requestLoadResource(channel, cdoResource.getRid(), resourceManager
              .getPackageManager());
        }
      }
    }
