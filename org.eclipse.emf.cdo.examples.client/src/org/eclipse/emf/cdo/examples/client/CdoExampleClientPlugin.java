 ...
 */
public class CdoExampleClientPlugin extends AbstractPlugin
{
  public static final String CONTEXT_PATH = "META-INF/";

  public static final String RESOURCE_URI = "cdo:///org/eclipse/net4j/cdo/test/res1";

  public static final String RESOURCE_URI2 = "cdo:///org/eclipse/net4j/cdo/test/res2";

  //The shared instance.
  private static CdoExampleClientPlugin plugin;
   ...
   */
  public static CdoExampleClientPlugin getDefault()
  {
    return plugin;
  }
