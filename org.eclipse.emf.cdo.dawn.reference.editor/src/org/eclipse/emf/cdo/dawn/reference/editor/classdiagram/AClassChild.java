 ...
 * <ul>
 * <li>{@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.AClassChild#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.AClassChild#getAccessright <em>Accessright</em>}</li>
 * <li>{@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.AClassChild#getDataType <em>Data Type</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.ClassdiagramPackage#getAClassChild()
 * @model
 * @extends CDOObject
 * @generated
 */
public interface AClassChild extends CDOObject
{
   ...
   * @see #setName(String)
   * @see org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.ClassdiagramPackage#getAClassChild_Name()
   * @model default=""
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.AClassChild#getName
   ...
   * literals are from the enumeration {@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.AccessType}. <!--
   * begin-user-doc -->
   * <p>
   ...
   * @see org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.ClassdiagramPackage#getAClassChild_Accessright()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.AClassChild#getAccessright
  ...
  /**
   * Unsets the value of the '{@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.AClassChild#getAccessright
   * <em>Accessright</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #isSetAccessright()
   * @see #getAccessright()
   ...
   * @see org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.ClassdiagramPackage#getAClassChild_DataType()
   * @model
   * @generated
   */
  String getDataType();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.AClassChild#getDataType
