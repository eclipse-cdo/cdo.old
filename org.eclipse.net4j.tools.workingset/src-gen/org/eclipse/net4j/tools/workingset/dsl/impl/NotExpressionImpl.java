 ...
 * <ul>
 *   <li>{@link org.eclipse.net4j.tools.workingset.dsl.impl.NotExpressionImpl#getRight <em>Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotExpressionImpl extends BooleanExpressionImpl implements NotExpression
{
  ...
  {
    return DslPackage.Literals.NOT_EXPRESSION;
  }
  ...
  public NotificationChain basicSetRight(BooleanExpression newRight, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DslPackage.NOT_EXPRESSION__RIGHT, oldRight, newRight);
  ...
  public void setRight(BooleanExpression newRight)
  {
    if (newRight != right)
    {
      ...
      if (right != null)
        msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DslPackage.NOT_EXPRESSION__RIGHT, null, msgs);
      if (newRight != null)
        msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DslPackage.NOT_EXPRESSION__RIGHT, null, msgs);
      msgs = basicSetRight(newRight, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.NOT_EXPRESSION__RIGHT, newRight, newRight));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.NOT_EXPRESSION__RIGHT:
