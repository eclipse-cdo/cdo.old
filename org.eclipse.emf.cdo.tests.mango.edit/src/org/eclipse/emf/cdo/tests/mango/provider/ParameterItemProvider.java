 ...
 *
 * $Id: ParameterItemProvider.java,v 1.5 2009-01-10 14:54:18 estepper Exp $
 */
    ...
    IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
  {
    if (itemPropertyDescriptors == null)
    {
      ...
      addPassingPropertyDescriptor(object);
    }
  ...
  protected void addNamePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
        .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Parameter_name_feature"), getString(
        "_UI_PropertyDescriptor_description", "_UI_Parameter_name_feature", "_UI_Parameter_type"),
        MangoPackage.Literals.PARAMETER__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
        null));
  }
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
        .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Parameter_passing_feature"), getString(
        "_UI_PropertyDescriptor_description", "_UI_Parameter_passing_feature", "_UI_Parameter_type"),
        MangoPackage.Literals.PARAMETER__PASSING, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
        null));
  }
