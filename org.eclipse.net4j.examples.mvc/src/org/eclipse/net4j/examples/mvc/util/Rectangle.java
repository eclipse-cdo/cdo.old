...
public final class Rectangle
{
   ...
   * <p>
   * The union of two rectangles is the smallest single rectangle that completely covers both of the
   * areas covered by the two given rectangles.
   * </p>
   * 
   * @param rect
  ...
  public Rectangle intersection(Rectangle rect)
  {
    ...
    rhs = rect.y + rect.height;
    int bottom = lhs < rhs ? lhs : rhs;
    return new Rectangle(right < left ? 0 : left, bottom < top ? 0 : top, right < left ? 0 : right
            - left, bottom < top ? 0 : bottom - top);
  }
