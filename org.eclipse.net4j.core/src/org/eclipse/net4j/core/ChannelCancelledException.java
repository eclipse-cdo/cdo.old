...
public class ChannelCancelledException extends Net4jException
{
   ...
   * @param message
   */
  public ChannelCancelledException(String message)
  {
    super(message);
  }
   ...
   * @param cause
   */
  public ChannelCancelledException(Throwable cause)
  {
    super(cause);
  }
   ...
   * @param cause
   */
  public ChannelCancelledException(String message, Throwable cause)
  {
    super(message, cause);
  }
}
