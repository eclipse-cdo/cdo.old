...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.cdo.dbgen.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Table_name_feature"), getString(
				"_UI_PropertyDescriptor_description", "_UI_Table_name_feature", "_UI_Table_type"),
				DBGenPackage.Literals.TABLE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ? getString("_UI_Table_type") : getString("_UI_Table_type") + " "
				+ label;
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(DBGenPackage.Literals.TABLE__COLUMNS, DBGenFactory.eINSTANCE
				.createColumn()));

		newChildDescriptors.add(createChildParameter(DBGenPackage.Literals.TABLE__INDICES, DBGenFactory.eINSTANCE
				.createIndex()));
	}
