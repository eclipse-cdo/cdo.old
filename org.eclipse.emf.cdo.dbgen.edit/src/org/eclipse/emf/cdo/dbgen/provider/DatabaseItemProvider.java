		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Database_name_feature"), getString(
				"_UI_PropertyDescriptor_description", "_UI_Database_name_feature", "_UI_Database_type"),
				DBGenPackage.Literals.DATABASE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ? getString("_UI_Database_type") : getString("_UI_Database_type") + " "
				+ label;
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(DBGenPackage.Literals.DATABASE__TABLES, DBGenFactory.eINSTANCE
				.createTable()));
	}
