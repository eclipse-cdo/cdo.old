...
public class OrderOrderDetails2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OrderOrderDetails2ReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return Model1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistOrderOrderDetails_4004(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return Model1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistOrderOrderDetails_4004(getOldSource(), getNewTarget());
	}
