 ...
 * @generated
 */
public class CategoryProducts2ViewFactory extends ConnectionViewFactory
{
      ...
      int index, boolean persisted)
  {
    ...
    {
      semanticHint = Model1VisualIDRegistry.getType(CategoryProducts2EditPart.VISUAL_ID);
