 ...
 * @generated
 */
public class PurchaseOrderViewFactory extends AbstractShapeViewFactory
{
      ...
      int index, boolean persisted)
  {
    ...
    {
      semanticHint = Model1VisualIDRegistry.getType(PurchaseOrderEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        Model1VisualIDRegistry.getType(PurchaseOrderDateEditPart.VISUAL_ID), ViewUtil.APPEND, true,
        getPreferencesHint());
  }
}
