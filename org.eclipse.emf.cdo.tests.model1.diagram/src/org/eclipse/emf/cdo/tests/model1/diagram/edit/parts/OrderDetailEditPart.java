...
public class OrderDetailEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OrderDetailItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OrderDetailCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OrderDetailPriceEditPart) {
			((OrderDetailPriceEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureSalesOrderNameFigure());
			return true;
		}
		return false;
	}
