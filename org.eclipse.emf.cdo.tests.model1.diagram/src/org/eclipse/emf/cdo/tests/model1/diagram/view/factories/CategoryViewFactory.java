 ...
 * @generated
 */
public class CategoryViewFactory extends AbstractShapeViewFactory
{
      ...
      int index, boolean persisted)
  {
    ...
    {
      semanticHint = Model1VisualIDRegistry.getType(CategoryEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view, Model1VisualIDRegistry.getType(CategoryNameEditPart.VISUAL_ID),
