...
import org.eclipse.emf.cdo.tests.model1.diagram.edit.policies.CustomerCanonicalEditPolicy;
import org.eclipse.emf.cdo.tests.model1.diagram.edit.policies.CustomerItemSemanticEditPolicy;
...
public class CustomerEditPart extends ShapeNodeEditPart
{
  ...
  protected void createDefaultEditPolicies()
  {
    ...
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CustomerCanonicalEditPolicy());
  ...
  {
    if (childEditPart instanceof CustomerNameEditPart)
    {
      ((CustomerNameEditPart)childEditPart).setLabel(getPrimaryShape().getFigureCustomerNameFigure());
      return true;
    }
    return false;
  }
  ...
  {
    return getChildBySemanticHint(Model1VisualIDRegistry.getType(CustomerNameEditPart.VISUAL_ID));
  }

  /**
   * @generated
   */
  public class CustomerFigure extends RectangleFigure
  {

    /**
     * @generated
     */
    private WrappingLabel fFigureCustomerStereotypeFigure;

    /**
     * @generated
     */
    private WrappingLabel fFigureCustomerNameFigure;
    ...
    private void createContents()
    {
      ...
      fFigureCustomerStereotypeFigure = new WrappingLabel();
      fFigureCustomerStereotypeFigure.setText("<<Customer>>");

      this.add(fFigureCustomerStereotypeFigure);

      fFigureCustomerNameFigure = new WrappingLabel();
     ...
     * @generated
     */
    public WrappingLabel getFigureCustomerStereotypeFigure()
    {
     ...
     * @generated
     */
    public WrappingLabel getFigureCustomerNameFigure()
    {
