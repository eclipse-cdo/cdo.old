...
public class Model1DiagramUpdater
{
  ...
  public static List getCompany_1000SemanticChildren(View view)
  {
    ...
    for (Iterator it = modelElement.getSuppliers().iterator(); it.hasNext();)
    {
      ...
      int visualID = Model1VisualIDRegistry.getNodeVisualID(view, childElement);
    ...
    for (Iterator it = modelElement.getCategories().iterator(); it.hasNext();)
    {
    ...
    for (Iterator it = modelElement.getPurchaseOrders().iterator(); it.hasNext();)
    {
    ...
    for (Iterator it = modelElement.getSalesOrders().iterator(); it.hasNext();)
    {
    ...
    for (Iterator semanticIterator = getPhantomNodesIterator(resource); semanticIterator.hasNext();)
    {
      ...
      {
        result.add(new Model1NodeDescriptor(childElement, Product1EditPart.VISUAL_ID));
        continue;
      }
      if (Model1VisualIDRegistry.getNodeVisualID(view, childElement) == SalesOrderEditPart.VISUAL_ID)
      {
        result.add(new Model1NodeDescriptor(childElement, SalesOrderEditPart.VISUAL_ID));
        continue;
      }
      if (Model1VisualIDRegistry.getNodeVisualID(view, childElement) == OrderAddressEditPart.VISUAL_ID)
      {
        result.add(new Model1NodeDescriptor(childElement, OrderAddressEditPart.VISUAL_ID));
        continue;
      }
    }
    return result;
  ...
  public static List getCategory_2002ContainedLinks(View view)
  {
    ...
    List result = new LinkedList();
    result.addAll(getOutgoingFeatureModelFacetLinks_Category_Products_4001(modelElement));
    return result;
  }
  ...
  public static List getPurchaseOrder_2004ContainedLinks(View view)
  {
    ...
    List result = new LinkedList();
    result.addAll(getOutgoingFeatureModelFacetLinks_PurchaseOrder_Supplier_4002(modelElement));
    result.addAll(getOutgoingFeatureModelFacetLinks_Order_OrderDetails_4004(modelElement));
    return result;
  }
  ...
  public static List getSalesOrder_2005ContainedLinks(View view)
  {
    ...
    List result = new LinkedList();
    result.addAll(getOutgoingFeatureModelFacetLinks_SalesOrder_Customer_4003(modelElement));
    result.addAll(getOutgoingFeatureModelFacetLinks_Order_OrderDetails_4004(modelElement));
    return result;
  }
  ...
  public static List getOrderAddress_2006ContainedLinks(View view)
  {
    ...
    List result = new LinkedList();
    result.addAll(getOutgoingFeatureModelFacetLinks_Order_OrderDetails_4004(modelElement));
    result.addAll(getOutgoingFeatureModelFacetLinks_OrderDetail_Product_4005(modelElement));
    return result;
  }
  ...
  public static List getSupplier_2001IncomingLinks(View view)
  {
    ...
    List result = new LinkedList();
    result.addAll(getIncomingFeatureModelFacetLinks_PurchaseOrder_Supplier_4002(modelElement, crossReferences));
    return result;
  }
  ...
  public static List getCustomer_2003IncomingLinks(View view)
  {
    ...
    Map crossReferences = EcoreUtil.CrossReferencer.find(view.eResource().getResourceSet().getResources());
    List result = new LinkedList();
    result.addAll(getIncomingFeatureModelFacetLinks_SalesOrder_Customer_4003(modelElement, crossReferences));
    return result;
  }
  ...
  public static List getOrderAddress_2006IncomingLinks(View view)
  {
    ...
    Map crossReferences = EcoreUtil.CrossReferencer.find(view.eResource().getResourceSet().getResources());
    List result = new LinkedList();
    result.addAll(getIncomingFeatureModelFacetLinks_Order_OrderDetails_4004(modelElement, crossReferences));
    return result;
  }
  ...
  public static List getProduct1_2008IncomingLinks(View view)
  {
    ...
    Map crossReferences = EcoreUtil.CrossReferencer.find(view.eResource().getResourceSet().getResources());
    List result = new LinkedList();
    result.addAll(getIncomingFeatureModelFacetLinks_Category_Products_4001(modelElement, crossReferences));
    result.addAll(getIncomingFeatureModelFacetLinks_OrderDetail_Product_4005(modelElement, crossReferences));
    return result;
  }
   ...
   * @generated
   */
  private static Collection getIncomingFeatureModelFacetLinks_Category_Products_4001(Product1 target,
      Map crossReferences)
  {
    ...
    for (Iterator it = settings.iterator(); it.hasNext();)
    {
      ...
      if (setting.getEStructuralFeature() == Model1Package.eINSTANCE.getCategory_Products())
      {
        result.add(new Model1LinkDescriptor(setting.getEObject(), target, Model1ElementTypes.CategoryProducts_4001,
   ...
   * @generated
   */
  private static Collection getIncomingFeatureModelFacetLinks_PurchaseOrder_Supplier_4002(Supplier target,
      Map crossReferences)
  {
    Collection result = new LinkedList();
    Collection settings = (Collection)crossReferences.get(target);
    ...
    {
      EStructuralFeature.Setting setting = (EStructuralFeature.Setting)it.next();
      if (setting.getEStructuralFeature() == Model1Package.eINSTANCE.getPurchaseOrder_Supplier())
      {
        result.add(new Model1LinkDescriptor(setting.getEObject(), target,
            Model1ElementTypes.PurchaseOrderSupplier_4002, CategoryProductsEditPart.VISUAL_ID));
      }
    }
    return result;
  }
   ...
   * @generated
   */
  private static Collection getIncomingFeatureModelFacetLinks_SalesOrder_Customer_4003(Customer target,
      Map crossReferences)
  {
    Collection result = new LinkedList();
    Collection settings = (Collection)crossReferences.get(target);
    ...
    {
      EStructuralFeature.Setting setting = (EStructuralFeature.Setting)it.next();
      if (setting.getEStructuralFeature() == Model1Package.eINSTANCE.getSalesOrder_Customer())
      {
        result.add(new Model1LinkDescriptor(setting.getEObject(), target, Model1ElementTypes.SalesOrderCustomer_4003,
   ...
   * @generated
   */
  private static Collection getIncomingFeatureModelFacetLinks_Order_OrderDetails_4004(OrderDetail target,
      Map crossReferences)
  {
    Collection result = new LinkedList();
    Collection settings = (Collection)crossReferences.get(target);
    ...
    {
      EStructuralFeature.Setting setting = (EStructuralFeature.Setting)it.next();
      if (setting.getEStructuralFeature() == Model1Package.eINSTANCE.getOrder_OrderDetails())
      {
        result.add(new Model1LinkDescriptor(setting.getEObject(), target, Model1ElementTypes.OrderOrderDetails_4004,
   ...
   * @generated
   */
  private static Collection getIncomingFeatureModelFacetLinks_OrderDetail_Product_4005(Product1 target,
      Map crossReferences)
  {
    Collection result = new LinkedList();
    Collection settings = (Collection)crossReferences.get(target);
    ...
    {
      EStructuralFeature.Setting setting = (EStructuralFeature.Setting)it.next();
      if (setting.getEStructuralFeature() == Model1Package.eINSTANCE.getOrderDetail_Product())
      {
        result.add(new Model1LinkDescriptor(setting.getEObject(), target, Model1ElementTypes.OrderDetailProduct_4005,
   ...
   * @generated
   */
  private static Collection getOutgoingFeatureModelFacetLinks_Category_Products_4001(Category source)
  {
    Collection result = new LinkedList();
    for (Iterator destinations = source.getProducts().iterator(); destinations.hasNext();)
    {
      Product1 destination = (Product1)destinations.next();
      result.add(new Model1LinkDescriptor(source, destination, Model1ElementTypes.CategoryProducts_4001,
          CategoryProducts2EditPart.VISUAL_ID));
    }
    return result;
  }
   ...
   * @generated
   */
  private static Collection getOutgoingFeatureModelFacetLinks_PurchaseOrder_Supplier_4002(PurchaseOrder source)
  {
    Collection result = new LinkedList();
    ...
    result.add(new Model1LinkDescriptor(source, destination, Model1ElementTypes.PurchaseOrderSupplier_4002,
   ...
   * @generated
   */
  private static Collection getOutgoingFeatureModelFacetLinks_SalesOrder_Customer_4003(SalesOrder source)
  {
    Collection result = new LinkedList();
    ...
    result.add(new Model1LinkDescriptor(source, destination, Model1ElementTypes.SalesOrderCustomer_4003,
        SalesOrderCustomerEditPart.VISUAL_ID));
    return result;
  }
   ...
   * @generated
   */
  private static Collection getOutgoingFeatureModelFacetLinks_Order_OrderDetails_4004(Order source)
  {
    Collection result = new LinkedList();
    for (Iterator destinations = source.getOrderDetails().iterator(); destinations.hasNext();)
    {
      OrderDetail destination = (OrderDetail)destinations.next();
      result.add(new Model1LinkDescriptor(source, destination, Model1ElementTypes.OrderOrderDetails_4004,
          OrderOrderDetails2EditPart.VISUAL_ID));
    }
    return result;
  }
   ...
   * @generated
   */
  private static Collection getOutgoingFeatureModelFacetLinks_OrderDetail_Product_4005(OrderDetail source)
  {
    Collection result = new LinkedList();
    ...
    result.add(new Model1LinkDescriptor(source, destination, Model1ElementTypes.OrderDetailProduct_4005,
        OrderOrderDetailsEditPart.VISUAL_ID));
    return result;
  }
