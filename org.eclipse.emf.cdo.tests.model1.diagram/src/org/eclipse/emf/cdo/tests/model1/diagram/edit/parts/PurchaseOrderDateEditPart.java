 ...
 * @generated
 */
public class PurchaseOrderDateEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(
					Model1ElementTypes.PurchaseOrder_2004, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), Model1EditPartFactory
