 ...
 * @generated
 */
public class PurchaseOrderDateEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
   ...
   * @generated
   */
  public PurchaseOrderDateEditPart(View view)
  {
    super(view);
  }
  ...
  protected Image getLabelIcon()
  {
    ...
    return Model1ElementTypes.getImage(parserElement.eClass());
  }
  ...
  public void setLabelText(String text)
  {
    ...
    if (pdEditPolicy instanceof Model1TextSelectionEditPolicy)
    {
      ((Model1TextSelectionEditPolicy)pdEditPolicy).refreshFeedback();
    }
  }
  ...
  public IParser getParser()
  {
    if (parser == null)
    {
      ...
      IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.PurchaseOrder_2004,
  ...
  protected DirectEditManager getManager()
  {
    if (manager == null)
    {
      setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this),
          Model1EditPartFactory.getTextCellEditorLocator(this)));
    }
    return manager;
  }
