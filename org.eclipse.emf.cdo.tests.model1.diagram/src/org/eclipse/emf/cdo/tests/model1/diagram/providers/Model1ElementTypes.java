...
public class Model1ElementTypes extends ElementInitializers {
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(PurchaseOrder_2004, Model1Package.eINSTANCE
					.getPurchaseOrder());

			elements.put(SalesOrder_2005, Model1Package.eINSTANCE
					.getSalesOrder());

			elements.put(OrderAddress_2006, Model1Package.eINSTANCE
					.getOrderAddress());

			elements.put(OrderDetail_2007, Model1Package.eINSTANCE
					.getOrderDetail());

			elements.put(Product1_2008, Model1Package.eINSTANCE.getProduct1());

			elements.put(CategoryProducts_4001, Model1Package.eINSTANCE
					.getCategory_Products());

			elements.put(PurchaseOrderSupplier_4002, Model1Package.eINSTANCE
					.getPurchaseOrder_Supplier());

			elements.put(SalesOrderCustomer_4003, Model1Package.eINSTANCE
					.getSalesOrder_Customer());

			elements.put(OrderOrderDetails_4004, Model1Package.eINSTANCE
					.getOrder_OrderDetails());

			elements.put(OrderDetailProduct_4005, Model1Package.eINSTANCE
