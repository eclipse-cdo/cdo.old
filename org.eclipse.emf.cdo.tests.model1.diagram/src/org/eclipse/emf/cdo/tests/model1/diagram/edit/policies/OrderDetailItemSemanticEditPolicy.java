 ...
 * @generated
 */
public class OrderDetailItemSemanticEditPolicy extends Model1BaseItemSemanticEditPolicy
{
  ...
  protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req)
  {
    ...
    {
      return getGEFWrapper(new SalesOrderCustomerCreateCommand(req, req.getSource(), req.getTarget()));
    }
