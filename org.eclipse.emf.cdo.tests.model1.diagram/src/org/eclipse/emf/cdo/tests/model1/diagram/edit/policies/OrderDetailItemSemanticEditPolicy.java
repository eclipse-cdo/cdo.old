...
import org.eclipse.emf.cdo.tests.model1.diagram.edit.commands.SalesOrderCustomerCreateCommand;
import org.eclipse.emf.cdo.tests.model1.diagram.edit.commands.SalesOrderCustomerReorientCommand;
 ...
 * @generated
 */
public class OrderDetailItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (Model1ElementTypes.SalesOrderCustomer_4003 == req.getElementType()) {
			return getGEFWrapper(new SalesOrderCustomerCreateCommand(req, req
					.getSource(), req.getTarget()));
		}
		if (Model1ElementTypes.OrderOrderDetails_4004 == req.getElementType()) {
			return getGEFWrapper(new OrderOrderDetails2CreateCommand(req, req
					.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case SalesOrderCustomerEditPart.VISUAL_ID:
			return getGEFWrapper(new SalesOrderCustomerReorientCommand(req));
