...
public class Model1VisualIDRegistry
{
  ...
  public static int getVisualID(View view)
  {
    ...
    return org.eclipse.emf.cdo.tests.model1.diagram.part.Model1VisualIDRegistry.getVisualID(view.getType());
  }
  ...
  public static int getVisualID(String type)
  {
    ...
    catch (NumberFormatException e)
    {
      ...
      {
        Model1DiagramEditorPlugin.getInstance().logError("Unable to parse view type as a visualID number: " + type);
      }
    }
    return -1;
  }
  ...
  public static int getDiagramVisualID(EObject domainElement)
  {
    ...
    if (Model1Package.eINSTANCE.getCompany().isSuperTypeOf(domainElement.eClass()) && isDiagram((Company)domainElement))
    {
      return CompanyEditPart.VISUAL_ID;
    }
    return -1;
  ...
  public static int getNodeVisualID(View containerView, EObject domainElement)
  {
    ...
    case CompanyEditPart.VISUAL_ID:
      if (Model1Package.eINSTANCE.getSupplier().isSuperTypeOf(domainElement.eClass()))
      {
        return SupplierEditPart.VISUAL_ID;
      }
      if (Model1Package.eINSTANCE.getCategory().isSuperTypeOf(domainElement.eClass()))
      {
        return CategoryEditPart.VISUAL_ID;
      }
      if (Model1Package.eINSTANCE.getCustomer().isSuperTypeOf(domainElement.eClass()))
      {
        return CustomerEditPart.VISUAL_ID;
      }
      if (Model1Package.eINSTANCE.getPurchaseOrder().isSuperTypeOf(domainElement.eClass()))
      {
        return PurchaseOrderEditPart.VISUAL_ID;
      }
      if (Model1Package.eINSTANCE.getSalesOrder().isSuperTypeOf(domainElement.eClass()))
      {
        return OrderDetailEditPart.VISUAL_ID;
      }
      if (Model1Package.eINSTANCE.getOrderAddress().isSuperTypeOf(domainElement.eClass()))
      {
        return Product1EditPart.VISUAL_ID;
      }
      if (Model1Package.eINSTANCE.getOrderDetail().isSuperTypeOf(domainElement.eClass()))
      {
        return SalesOrderEditPart.VISUAL_ID;
      }
      if (Model1Package.eINSTANCE.getProduct1().isSuperTypeOf(domainElement.eClass()))
      {
