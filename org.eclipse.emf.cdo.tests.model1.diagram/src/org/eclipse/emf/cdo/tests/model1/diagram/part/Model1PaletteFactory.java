...
public class Model1PaletteFactory
{
  ...
  private ToolEntry createCategory1CreationTool()
  {
    ...
    NodeToolEntry entry = new NodeToolEntry(Messages.Category1CreationTool_title, null, types);
    entry.setSmallIcon(Model1ElementTypes.getImageDescriptor(Model1ElementTypes.Category_2002));
  ...
  private ToolEntry createSupplier2CreationTool()
  {
    ...
    NodeToolEntry entry = new NodeToolEntry(Messages.Supplier2CreationTool_title, null, types);
    entry.setSmallIcon(Model1ElementTypes.getImageDescriptor(Model1ElementTypes.Supplier_2001));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createCustomer3CreationTool()
  {
    ...
    NodeToolEntry entry = new NodeToolEntry(Messages.Customer3CreationTool_title, null, types);
    entry.setSmallIcon(Model1ElementTypes.getImageDescriptor(Model1ElementTypes.Customer_2003));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createPurchaseOrder4CreationTool()
  {
    ...
    NodeToolEntry entry = new NodeToolEntry(Messages.PurchaseOrder4CreationTool_title, null, types);
    entry.setSmallIcon(Model1ElementTypes.getImageDescriptor(Model1ElementTypes.PurchaseOrder_2004));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createSalesOrder5CreationTool()
  {
    ...
    NodeToolEntry entry = new NodeToolEntry(Messages.SalesOrder5CreationTool_title, null, types);
    entry.setSmallIcon(Model1ElementTypes.getImageDescriptor(Model1ElementTypes.SalesOrder_2005));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createOrderDetail6CreationTool()
  {
    ...
    NodeToolEntry entry = new NodeToolEntry(Messages.OrderDetail6CreationTool_title, null, types);
    entry.setSmallIcon(Model1ElementTypes.getImageDescriptor(Model1ElementTypes.OrderAddress_2006));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createProduct17CreationTool()
  {
    ...
    NodeToolEntry entry = new NodeToolEntry(Messages.Product17CreationTool_title, null, types);
    entry.setSmallIcon(Model1ElementTypes.getImageDescriptor(Model1ElementTypes.Product1_2008));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createSupplier1CreationTool()
  {
    ...
    LinkToolEntry entry = new LinkToolEntry(Messages.Supplier1CreationTool_title, null, types);
    entry.setSmallIcon(Model1DiagramEditorPlugin.findImageDescriptor("../icons/myobjects/SolidLine.gif")); //$NON-NLS-1$
    entry.setLargeIcon(Model1DiagramEditorPlugin.findImageDescriptor("../icons/myobjects/SolidLine.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createCustomer2CreationTool()
  {
    ...
    LinkToolEntry entry = new LinkToolEntry(Messages.Customer2CreationTool_title, null, types);
    entry.setSmallIcon(Model1DiagramEditorPlugin.findImageDescriptor("../icons/myobjects/SolidLine.gif")); //$NON-NLS-1$
    entry.setLargeIcon(Model1DiagramEditorPlugin.findImageDescriptor("../icons/myobjects/SolidLine.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createOrderDetail3CreationTool()
  {
    ...
    LinkToolEntry entry = new LinkToolEntry(Messages.OrderDetail3CreationTool_title, null, types);
    entry.setSmallIcon(Model1DiagramEditorPlugin.findImageDescriptor("../icons/myobjects/Association_composite.gif")); //$NON-NLS-1$
    entry.setLargeIcon(Model1DiagramEditorPlugin.findImageDescriptor("../icons/myobjects/Association_composite.gif")); //$NON-NLS-1$
    return entry;
  }
  ...
  private ToolEntry createProduct4CreationTool()
  {
    ...
    LinkToolEntry entry = new LinkToolEntry(Messages.Product4CreationTool_title, null, types);
    entry.setSmallIcon(Model1DiagramEditorPlugin.findImageDescriptor("../icons/myobjects/SolidLine.gif")); //$NON-NLS-1$
    entry.setLargeIcon(Model1DiagramEditorPlugin.findImageDescriptor("../icons/myobjects/SolidLine.gif")); //$NON-NLS-1$
    return entry;
  }
