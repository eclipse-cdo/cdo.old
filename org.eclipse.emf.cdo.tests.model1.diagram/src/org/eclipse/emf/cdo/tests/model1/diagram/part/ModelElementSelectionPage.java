...
public class ModelElementSelectionPage extends WizardPage
{
  ...
  public void createControl(Composite parent)
  {
    ...
    modelViewer.setContentProvider(new AdapterFactoryContentProvider(Model1DiagramEditorPlugin.getInstance()
        .getItemProvidersAdapterFactory()));
    modelViewer.setLabelProvider(new AdapterFactoryLabelProvider(Model1DiagramEditorPlugin.getInstance()
        .getItemProvidersAdapterFactory()));
    if (selectedModelElement != null)
    {
      modelViewer.setInput(selectedModelElement.eResource());
