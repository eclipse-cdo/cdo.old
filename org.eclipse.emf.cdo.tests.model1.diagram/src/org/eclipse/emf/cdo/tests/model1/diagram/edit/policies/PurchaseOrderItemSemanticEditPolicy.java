 ...
 * @generated
 */
public class PurchaseOrderItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (Model1ElementTypes.PurchaseOrderSupplier_4002 == req
				.getElementType()) {
			return getGEFWrapper(new CategoryProductsCreateCommand(req, req
