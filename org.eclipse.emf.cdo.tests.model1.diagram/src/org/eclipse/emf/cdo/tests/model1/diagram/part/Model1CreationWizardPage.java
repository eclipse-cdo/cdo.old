...
public class Model1CreationWizardPage extends WizardNewFileCreationPage {
	 ...
	 * @generated
	 */
	public Model1CreationWizardPage(String pageName,
	...
	public void createControl(Composite parent) {
		...
		setFileName(Model1DiagramEditorUtil.getUniqueFileName(
	...
	protected boolean validatePage() {
		...
		if (extension != null
			...
			setErrorMessage(NLS.bind(
					Messages.Model1CreationWizardPageExtensionError, extension));
			return false;
		}
		return true;
	}
