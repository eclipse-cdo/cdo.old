 ...
 * @generated
 */
public class OrderOrderDetails2ViewFactory extends ConnectionViewFactory
{
      ...
      int index, boolean persisted)
  {
    ...
    {
      semanticHint = Model1VisualIDRegistry.getType(OrderOrderDetails2EditPart.VISUAL_ID);
