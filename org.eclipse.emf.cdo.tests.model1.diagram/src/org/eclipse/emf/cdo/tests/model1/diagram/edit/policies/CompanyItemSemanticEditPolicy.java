 ...
 * @generated
 */
public class CompanyItemSemanticEditPolicy extends Model1BaseItemSemanticEditPolicy
{
  ...
  protected Command getCreateCommand(CreateElementRequest req)
  {
    if (Model1ElementTypes.Supplier_2001 == req.getElementType())
    {
      ...
      {
        req.setContainmentFeature(Model1Package.eINSTANCE.getCompany_Suppliers());
      }
    ...
    if (Model1ElementTypes.Category_2002 == req.getElementType())
    {
      if (req.getContainmentFeature() == null)
      {
        req.setContainmentFeature(Model1Package.eINSTANCE.getCompany_Categories());
      }
    ...
    if (Model1ElementTypes.Customer_2003 == req.getElementType())
    {
      if (req.getContainmentFeature() == null)
      {
        req.setContainmentFeature(Model1Package.eINSTANCE.getCompany_Customers());
      }
    ...
    if (Model1ElementTypes.PurchaseOrder_2004 == req.getElementType())
    {
      if (req.getContainmentFeature() == null)
      {
        req.setContainmentFeature(Model1Package.eINSTANCE.getCompany_PurchaseOrders());
      }
    ...
    if (Model1ElementTypes.SalesOrder_2005 == req.getElementType())
    {
      if (req.getContainmentFeature() == null)
      {
        req.setContainmentFeature(Model1Package.eINSTANCE.getCompany_SalesOrders());
      }
