 ...
 * @generated
 */
public class Model1ParserProvider extends AbstractProvider implements IParserProvider
{
  ...
  {
    EAttribute[] features = new EAttribute[] { Model1Package.eINSTANCE.getAddress_Name(), };
  ...
  {
    EAttribute[] features = new EAttribute[] { Model1Package.eINSTANCE.getCategory_Name(), };
    MessageFormatParser parser = new MessageFormatParser(features);
    return parser;
  }
  ...
  {
    EAttribute[] features = new EAttribute[] { Model1Package.eINSTANCE.getPurchaseOrder_Date(), };
    MessageFormatParser parser = new MessageFormatParser(features);
    return parser;
  }
  ...
  {
    EAttribute[] features = new EAttribute[] { Model1Package.eINSTANCE.getSalesOrder_Id(), };
    MessageFormatParser parser = new MessageFormatParser(features);
    return parser;
  }
  ...
  {
    EAttribute[] features = new EAttribute[] { Model1Package.eINSTANCE.getOrderDetail_Price(), };
    MessageFormatParser parser = new MessageFormatParser(features);
    return parser;
  }
  ...
  {
    EAttribute[] features = new EAttribute[] { Model1Package.eINSTANCE.getProduct1_Name(), };
    MessageFormatParser parser = new MessageFormatParser(features);
    return parser;
  }
