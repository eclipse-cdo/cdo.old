 ...
 * @generated
 */
public class OrderDetailViewFactory extends AbstractShapeViewFactory
{
      ...
      int index, boolean persisted)
  {
    ...
    {
      semanticHint = Model1VisualIDRegistry.getType(OrderDetailEditPart.VISUAL_ID);
    ...
    getViewService()
        .createNode(eObjectAdapter, view, Model1VisualIDRegistry.getType(OrderDetailPriceEditPart.VISUAL_ID),
