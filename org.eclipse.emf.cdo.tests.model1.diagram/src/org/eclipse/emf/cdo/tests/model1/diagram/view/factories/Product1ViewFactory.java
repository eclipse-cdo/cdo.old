 ...
 * @generated
 */
public class Product1ViewFactory extends AbstractShapeViewFactory
{
      ...
      int index, boolean persisted)
  {
    ...
    {
      semanticHint = Model1VisualIDRegistry.getType(Product1EditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view, Model1VisualIDRegistry.getType(Product1NameEditPart.VISUAL_ID),
