...
import org.eclipse.emf.cdo.tests.model1.diagram.edit.policies.CategoryCanonicalEditPolicy;
import org.eclipse.emf.cdo.tests.model1.diagram.edit.policies.CategoryItemSemanticEditPolicy;
...
public class CategoryEditPart extends ShapeNodeEditPart
{
  ...
  protected void createDefaultEditPolicies()
  {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CategoryItemSemanticEditPolicy());
    installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CategoryCanonicalEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart)
  {
    ...
    {
      ((CategoryNameEditPart)childEditPart).setLabel(getPrimaryShape().getFigureCategoryNameFigure());
      return true;
    }
    return false;
  }
  ...
  {
    return getChildBySemanticHint(Model1VisualIDRegistry.getType(CategoryNameEditPart.VISUAL_ID));
  }
  ...
  public class CategoryFigure extends RectangleFigure
  {
     ...
     * @generated
     */
    private WrappingLabel fFigureCategoryStereotypeFigure;

    /**
     * @generated
     */
    private WrappingLabel fFigureCategoryNameFigure;
    ...
    private void createContents()
    {
      ...
      fFigureCategoryStereotypeFigure = new WrappingLabel();
      fFigureCategoryStereotypeFigure.setText("<<Category>>");

      this.add(fFigureCategoryStereotypeFigure);

      fFigureCategoryNameFigure = new WrappingLabel();
     ...
     * @generated
     */
    public WrappingLabel getFigureCategoryStereotypeFigure()
    {
     ...
     * @generated
     */
    public WrappingLabel getFigureCategoryNameFigure()
    {
