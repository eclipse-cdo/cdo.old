 ...
 * @generated
 */
public class SupplierViewFactory extends AbstractShapeViewFactory
{
      ...
      int index, boolean persisted)
  {
    ...
    {
      semanticHint = Model1VisualIDRegistry.getType(SupplierEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view, Model1VisualIDRegistry.getType(SupplierNameEditPart.VISUAL_ID),
