 ...
 * @generated
 */
public class Model1NavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider
{
  ...
  static
  {
    Model1DiagramEditorPlugin.getInstance().getImageRegistry().put(
  ...
  public void updateLabel(ViewerLabel label, TreePath elementPath)
  {
    ...
    if (element instanceof Model1NavigatorItem && !isOwnView(((Model1NavigatorItem)element).getView()))
    {
      return;
    }
  ...
  public Image getImage(Object element)
  {
    if (element instanceof Model1NavigatorGroup)
    {
      ...
      return Model1DiagramEditorPlugin.getInstance().getBundledImage(group.getIcon());
    }
  ...
  {
    ImageRegistry imageRegistry = Model1DiagramEditorPlugin.getInstance().getImageRegistry();
    Image image = imageRegistry.get(key);
    if (image == null && elementType != null && Model1ElementTypes.isKnownElementType(elementType))
    {
  ...
  private String getCompany_1000Text(View view)
  {
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1000); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  }
  ...
  {
    IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.Supplier_2001,
        (view.getElement() != null ? view.getElement() : view), Model1VisualIDRegistry
            .getType(SupplierNameEditPart.VISUAL_ID));
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5001); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  ...
  {
    IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.Category_2002,
        (view.getElement() != null ? view.getElement() : view), Model1VisualIDRegistry
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5002); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  ...
  {
    IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.Customer_2003,
        (view.getElement() != null ? view.getElement() : view), Model1VisualIDRegistry
            .getType(CustomerNameEditPart.VISUAL_ID));
    IParser parser = ParserService.getInstance().getParser(hintAdapter);
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5003); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  ...
  {
    IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.PurchaseOrder_2004, (view
        .getElement() != null ? view.getElement() : view), Model1VisualIDRegistry
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5004); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  ...
  {
    IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.SalesOrder_2005, (view
        .getElement() != null ? view.getElement() : view), Model1VisualIDRegistry
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5005); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  ...
  {
    IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.OrderAddress_2006, (view
        .getElement() != null ? view.getElement() : view), Model1VisualIDRegistry
        .getType(Product1NameEditPart.VISUAL_ID));
    IParser parser = ParserService.getInstance().getParser(hintAdapter);
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5006); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  ...
  {
    IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.OrderDetail_2007, (view
        .getElement() != null ? view.getElement() : view), Model1VisualIDRegistry
        .getType(SalesOrderIdEditPart.VISUAL_ID));
    IParser parser = ParserService.getInstance().getParser(hintAdapter);
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5007); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
  ...
  {
    IAdaptable hintAdapter = new Model1ParserProvider.HintAdapter(Model1ElementTypes.Product1_2008,
        (view.getElement() != null ? view.getElement() : view), Model1VisualIDRegistry
    ...
    {
      Model1DiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5008); //$NON-NLS-1$
      return ""; //$NON-NLS-1$
    }
