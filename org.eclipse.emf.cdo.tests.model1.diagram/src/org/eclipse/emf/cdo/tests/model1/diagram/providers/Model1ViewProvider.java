...
public class Model1ViewProvider extends AbstractViewProvider
{
  ...
  protected Class getNodeViewClass(IAdaptable semanticAdapter, View containerView, String semanticHint)
  {
    ...
    if (semanticHint == null)
    {
      ...
      visualID = Model1VisualIDRegistry.getNodeVisualID(containerView, domainElement);
    }
    else
    {
      ...
      if (elementType != null)
      {
        ...
        if (!Model1ElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType)))
        {
        ...
        if (domainElement != null && visualID != Model1VisualIDRegistry.getNodeVisualID(containerView, domainElement))
        {
      ...
      else
      {
        ...
        case SupplierNameEditPart.VISUAL_ID:
          if (SupplierEditPart.VISUAL_ID != Model1VisualIDRegistry.getVisualID(containerView)
        ...
        case CategoryNameEditPart.VISUAL_ID:
          if (CategoryEditPart.VISUAL_ID != Model1VisualIDRegistry.getVisualID(containerView)
              || containerView.getElement() != domainElement)
          {
            return null; // wrong container
          }
        ...
        case CustomerNameEditPart.VISUAL_ID:
          if (CustomerEditPart.VISUAL_ID != Model1VisualIDRegistry.getVisualID(containerView)
              || containerView.getElement() != domainElement)
          {
            return null; // wrong container
          }
        ...
        case PurchaseOrderDateEditPart.VISUAL_ID:
          if (PurchaseOrderEditPart.VISUAL_ID != Model1VisualIDRegistry.getVisualID(containerView)
              || containerView.getElement() != domainElement)
          {
            return null; // wrong container
          }
        ...
        case OrderDetailPriceEditPart.VISUAL_ID:
          if (OrderDetailEditPart.VISUAL_ID != Model1VisualIDRegistry.getVisualID(containerView)
              || containerView.getElement() != domainElement)
          {
            return null; // wrong container
          }
        ...
        case Product1NameEditPart.VISUAL_ID:
          if (Product1EditPart.VISUAL_ID != Model1VisualIDRegistry.getVisualID(containerView)
              || containerView.getElement() != domainElement)
          {
            return null; // wrong container
          }
        ...
        case SalesOrderIdEditPart.VISUAL_ID:
          if (SalesOrderEditPart.VISUAL_ID != Model1VisualIDRegistry.getVisualID(containerView)
              || containerView.getElement() != domainElement)
          {
            return null; // wrong container
          }
        ...
        case OrderAddressNameEditPart.VISUAL_ID:
          if (OrderAddressEditPart.VISUAL_ID != Model1VisualIDRegistry.getVisualID(containerView)
              || containerView.getElement() != domainElement)
          {
            return null; // wrong container
          }
  ...
  {
    if (containerView == null || !Model1VisualIDRegistry.canCreateNode(containerView, visualID))
    {
      return null;
    }
    switch (visualID)
  ...
  protected Class getEdgeViewClass(IAdaptable semanticAdapter, View containerView, String semanticHint)
  {
    ...
    EObject domainElement = getSemanticElement(semanticAdapter);
    if (domainElement != null && visualID != Model1VisualIDRegistry.getLinkWithClassVisualID(domainElement))
    {
