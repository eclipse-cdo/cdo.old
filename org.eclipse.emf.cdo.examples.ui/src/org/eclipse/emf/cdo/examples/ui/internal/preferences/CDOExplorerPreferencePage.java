 ...
 */
public class CDOExplorerPreferencePage extends FieldEditorPreferencePage implements
        IWorkbenchPreferencePage
{
  public CDOExplorerPreferencePage()
  {
    super(GRID);
    setPreferenceStore(ExampleUIActivator.getPlugin().getPreferenceStore());
    setDescription("CDO Explorer preferences");
  }
