...
public class DawnClassdiagramDiagramEditorUtil extends ClassdiagramDiagramEditorUtil
{
  ...
  public static boolean openDiagram(Resource diagram) throws PartInitException
  {
    ...
    // return null != page.openEditor(new FileEditorInput((IFile)workspaceResource), ClassdiagramDiagramEditor.ID);
    // }
    // return false;
    IWorkbenchPage page = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage();
    ...
    // return null != page.openEditor(new DawnEditorInput((DawnWrapperResource)diagram),
    // DawnClassdiagramDiagramEditor.ID);
  }
  ...
  public static Resource createDiagram(URI diagramURI, URI modelURI, IProgressMonitor progressMonitor)
  {
        ...
        Messages.ClassdiagramDiagramEditorUtil_CreateDiagramCommandLabel, Collections.EMPTY_LIST)
    {
      protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException
      {
        ...
        {
          // modelResource
          // .save(org.eclipse.emf.cdo.dawn.reference.editor.classdiagram.diagram.part.ClassdiagramDiagramEditorUtil
          // .getSaveOptions());
  ...
  // {
  // System.out.println("CONNECTING to: " + diagramURI);
  // TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE.createEditingDomain();
  // progressMonitor.beginTask(Messages.ClassdiagramDiagramEditorUtil_CreateDiagramProgressTask, 3);
  //
  // /**** open transaction BEGIN ******/
  // // List<EPackage> packages = new ArrayList<EPackage>();
  // // packages.add(NotationPackage.eINSTANCE);
  // // packages.add(ClassdiagramPackage.eINSTANCE);
  // CDOConnectionUtil.instance.init("repo1", "tcp", "localhost");
  // session = CDOConnectionUtil.instance.openSession();
  // transaction = CDOConnectionUtil.instance.openCurrentTransaction(editingDomain.getResourceSet(), diagramURI
  // .fragment());
  //
  // System.out.println("Diagram URI " + diagramURI);
  // diagramResource = (Resource)editingDomain.getResourceSet().createResource(diagramURI);
  //
  // System.out.println("RESOURCE: !!!!!" + diagramResource);
  // final String diagramName = diagramURI.lastSegment();
  // AbstractTransactionalCommand command = new AbstractTransactionalCommand(editingDomain,
  // Messages.ClassdiagramDiagramEditorUtil_CreateDiagramCommandLabel, Collections.EMPTY_LIST)
  // {
  ...
  // {
  //
  // System.out.println("Saving Resource: " + diagramResource.getURI());
  // diagramResource.save(Collections.EMPTY_MAP);
  // }
  // catch (IOException e)
  // {
  ...
  // }
  //
  // // ResourceHelper.printResourceSysout(diagramResource);
  // // setCharset(WorkspaceSynchronizer.getFile(diagramResource));
  // return diagramResource;
  // }
  ...
  // packages.add(NotationPackage.eINSTANCE);
  // packages.add(ClassdiagramPackage.eINSTANCE);
  // CDOConnectionUtil.instance.init(packages, false);
  // session = CDOConnectionUtil.instance.openSession("repo1");
  // transaction = CDOConnectionUtil.instance.getOrCreateCurrentTransaction(session, editingDomain.getResourceSet());
  //
  // // diagramURI= URI.createURI("cdo://"+session.getRepositoryInfo().getUUID()+"/"+diagramURI.lastSegment());
  // // System.out.println("UUID "+session.getRepositoryInfo().getUUID());
  // uri=diagramURI;
  // System.out.println("Diagram URI "+diagramURI);
  //
  //
  ...
  // final String diagramName = diagramURI.lastSegment();
  // AbstractTransactionalCommand command = new AbstractTransactionalCommand(editingDomain,
  // Messages.ClassdiagramDiagramEditorUtil_CreateDiagramCommandLabel,
  ...
  // {
  //
  // //diagramResource.save(classdiagram.diagram.part.ClassdiagramDiagramEditorUtil.getSaveOptions());
  // diagramResource.save(Collections.EMPTY_MAP);
  // transaction.commit();
  // transaction.close();
  // session.close();
